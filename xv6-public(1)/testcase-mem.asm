...
_testcase-mem:     file format elf32-i386
...
int main(void)
{
   ...
   f:	e8 df 03 00 00       	call   3f3 <getNumFreePages>
	printf(1, "Free pages: %d\n", free);
  14:	83 ec 04             	sub    $0x4,%esp
  17:	50                   	push   %eax
  18:	68 d8 07 00 00       	push   $0x7d8
  1d:	6a 01                	push   $0x1
  1f:	e8 8c 04 00 00       	call   4b0 <printf>

	printf(1, "Allocating 4 pages using sbrk\n");
  24:	58                   	pop    %eax
  25:	5a                   	pop    %edx
  26:	68 3c 08 00 00       	push   $0x83c
  2b:	6a 01                	push   $0x1
  2d:	e8 7e 04 00 00       	call   4b0 <printf>
	char* addr = (char*)sbrk(4 * 4096);
  32:	c7 04 24 00 40 00 00 	movl   $0x4000,(%esp)
  39:	e8 9d 03 00 00       	call   3db <sbrk>
  3e:	83 c4 10             	add    $0x10,%esp
  41:	89 c3                	mov    %eax,%ebx
	for(int i=0;i<4*4096;i++){
  43:	8d 90 00 40 00 00    	lea    0x4000(%eax),%edx
  49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		addr[i] = 'a';
  50:	c6 00 61             	movb   $0x61,(%eax)
	for(int i=0;i<4*4096;i++){
  53:	83 c0 01             	add    $0x1,%eax
  56:	39 d0                	cmp    %edx,%eax
  58:	75 f6                	jne    50 <main+0x50>
	}
	free = getNumFreePages();
  5a:	e8 94 03 00 00       	call   3f3 <getNumFreePages>
	printf(1, "Free pages: %d\n", free);
  5f:	83 ec 04             	sub    $0x4,%esp
  62:	50                   	push   %eax
  63:	68 d8 07 00 00       	push   $0x7d8
  68:	6a 01                	push   $0x1
  6a:	e8 41 04 00 00       	call   4b0 <printf>
	if(fork() == 0){
  6f:	e8 d7 02 00 00       	call   34b <fork>
  74:	83 c4 10             	add    $0x10,%esp
  77:	85 c0                	test   %eax,%eax
  79:	75 55                	jne    d0 <main+0xd0>
		printf(1, "Forked a process\n");
  7b:	52                   	push   %edx
  7c:	52                   	push   %edx
  7d:	68 e8 07 00 00       	push   $0x7e8
  82:	6a 01                	push   $0x1
  84:	e8 27 04 00 00       	call   4b0 <printf>
		free = getNumFreePages();
  89:	e8 65 03 00 00       	call   3f3 <getNumFreePages>
		printf(1, "Free pages: %d\n", free);
  ...
  99:	e8 12 04 00 00       	call   4b0 <printf>
		addr[4097] = 'b';
  9e:	c6 83 01 10 00 00 62 	movb   $0x62,0x1001(%ebx)
  ...
  ae:	e8 fd 03 00 00       	call   4b0 <printf>
		free = getNumFreePages();
  b3:	e8 3b 03 00 00       	call   3f3 <getNumFreePages>
		printf(1, "Free pages: %d\n", free);
  b8:	83 c4 0c             	add    $0xc,%esp
  bb:	50                   	push   %eax
  bc:	68 d8 07 00 00       	push   $0x7d8
  c1:	6a 01                	push   $0x1
  c3:	e8 e8 03 00 00       	call   4b0 <printf>
  c8:	83 c4 10             	add    $0x10,%esp
	}
	exit();
  cb:	e8 83 02 00 00       	call   353 <exit>
		wait();
  d0:	e8 86 02 00 00       	call   35b <wait>
		printf(1,"Child exited\n");
  d5:	50                   	push   %eax
  d6:	50                   	push   %eax
  d7:	68 14 08 00 00       	push   $0x814
  dc:	6a 01                	push   $0x1
  de:	e8 cd 03 00 00       	call   4b0 <printf>
		printf(1,"Value at addr[4097] = %c\n", addr[4097]);
  e3:	0f be 83 01 10 00 00 	movsbl 0x1001(%ebx),%eax
  ea:	83 c4 0c             	add    $0xc,%esp
  ed:	50                   	push   %eax
  ee:	68 22 08 00 00       	push   $0x822
  f3:	eb b7                	jmp    ac <main+0xac>
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
  f9:	66 90                	xchg   %ax,%ax
  fb:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 651:	a1 68 0b 00 00       	mov    0xb68,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 68 0b 00 00    	mov    %edx,0xb68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 68 0b 00 00    	mov    0xb68,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 68 0b 00 00    	mov    0xb68,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 68 0b 00 00    	mov    %edx,0xb68
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 68 0b 00 00 6c 	movl   $0xb6c,0xb68
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 6c 0b 00 00       	mov    $0xb6c,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 6c 0b 00 00 6c 	movl   $0xb6c,0xb6c
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 70 0b 00 00 00 	movl   $0x0,0xb70
 7c2:	00 00 00 
    if(p->s.size >= nunits){
