...
int main(void)
{
  ...
  11:	68 b8 07 00 00       	push   $0x7b8
  16:	6a 01                	push   $0x1
  18:	e8 73 04 00 00       	call   490 <printf>
  printf(1, "Virtual Pages: %d\n", numvp());
  1d:	e8 99 03 00 00       	call   3bb <numvp>
  22:	83 c4 0c             	add    $0xc,%esp
  25:	50                   	push   %eax
  26:	68 c7 07 00 00       	push   $0x7c7
  2b:	6a 01                	push   $0x1
  2d:	e8 5e 04 00 00       	call   490 <printf>
  printf(1, "Physical Pages: %d\n", numpp());
  32:	e8 8c 03 00 00       	call   3c3 <numpp>
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	50                   	push   %eax
  3b:	68 da 07 00 00       	push   $0x7da
  40:	6a 01                	push   $0x1
  42:	e8 49 04 00 00       	call   490 <printf>
  if(fork()){
  47:	e8 7f 02 00 00       	call   2cb <fork>
    printf(1, "Virtual Pages: %d\n", numvp());
  4c:	e8 6a 03 00 00       	call   3bb <numvp>
  51:	83 c4 0c             	add    $0xc,%esp
  54:	50                   	push   %eax
  55:	68 c7 07 00 00       	push   $0x7c7
  5a:	6a 01                	push   $0x1
  5c:	e8 2f 04 00 00       	call   490 <printf>
    printf(1, "Physical Pages: %d\n", numpp());
  61:	e8 5d 03 00 00       	call   3c3 <numpp>
  66:	83 c4 0c             	add    $0xc,%esp
  69:	50                   	push   %eax
  6a:	68 da 07 00 00       	push   $0x7da
  6f:	6a 01                	push   $0x1
  ...
  exit();
  76:	e8 58 02 00 00       	call   2d3 <exit>
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba ee 07 00 00       	mov    $0x7ee,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
 ...
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf fc 0a 00 00       	mov    $0xafc,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 7a2:	00 00 00 
    if(p->s.size >= nunits){
