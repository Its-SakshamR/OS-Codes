...
_testcase-prio:     file format elf32-i386
   ...
   e:	bb 01 00 00 00       	mov    $0x1,%ebx
{
  ...
  1c:	83 c3 01             	add    $0x1,%ebx
        setprio(i);
  1f:	e8 47 03 00 00       	call   36b <setprio>
        printf(1, "Priority : %d\n", getprio());
  24:	e8 4a 03 00 00       	call   373 <getprio>
  29:	83 c4 0c             	add    $0xc,%esp
  2c:	50                   	push   %eax
  2d:	68 88 07 00 00       	push   $0x788
  32:	6a 01                	push   $0x1
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 a0 07 00 00 	jmp    *0x7a0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 97 07 00 00       	mov    $0x797,%edx
        while(*s != 0){
