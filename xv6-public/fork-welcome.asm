...
_fork-welcome:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  18:	74 4c                	je     66 <main+0x66>
    {
      printf(1, "I am child with no welcome\n"); 
    }
  else if (ret1 > 0)
  1a:	7f 05                	jg     21 <main+0x21>
	  wait();
  ...
  exit();
  1c:	e8 e2 02 00 00       	call   303 <exit>
      wait();
  21:	e8 e5 02 00 00       	call   30b <wait>
  ...
  34:	c7 04 24 90 00 00 00 	movl   $0x90,(%esp)
  3b:	e8 9b 03 00 00       	call   3db <welcomeFunction>
      int ret2 = fork();
  40:	e8 b6 02 00 00       	call   2fb <fork>
      if (ret2 == 0)
  45:	83 c4 10             	add    $0x10,%esp
  48:	85 c0                	test   %eax,%eax
  4a:	74 2d                	je     79 <main+0x79>
      else if (ret2 > 0)
  4c:	7e ce                	jle    1c <main+0x1c>
	  wait();
  4e:	e8 b8 02 00 00       	call   30b <wait>
	  printf(1, "Parent reaped second child\n");
  53:	50                   	push   %eax
  54:	50                   	push   %eax
  ...
  64:	eb b6                	jmp    1c <main+0x1c>
      printf(1, "I am child with no welcome\n"); 
  66:	50                   	push   %eax
  67:	50                   	push   %eax
  68:	68 2f 08 00 00       	push   $0x82f
  6d:	6a 01                	push   $0x1
  6f:	e8 4c 04 00 00       	call   4c0 <printf>
  74:	83 c4 10             	add    $0x10,%esp
  77:	eb a3                	jmp    1c <main+0x1c>
	  printf(1, "I have returned from welcome function\n");
  79:	52                   	push   %edx
  7a:	52                   	push   %edx
  7b:	68 08 08 00 00       	push   $0x808
  80:	6a 01                	push   $0x1
  82:	e8 39 04 00 00       	call   4c0 <printf>
	  exit();
  87:	e8 77 02 00 00       	call   303 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <welcome>:
{
  ...
  96:	68 e8 07 00 00       	push   $0x7e8
  9b:	6a 01                	push   $0x1
  9d:	e8 1e 04 00 00       	call   4c0 <printf>
  welcomeDone();
  a2:	83 c4 10             	add    $0x10,%esp
}
  a5:	c9                   	leave  
  welcomeDone();
  a6:	e9 38 03 00 00       	jmp    3e3 <welcomeDone>
  ab:	66 90                	xchg   %ax,%ax
  ad:	66 90                	xchg   %ax,%ax
  af:	90                   	nop
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 449:	0f b6 92 e4 08 00 00 	movzbl 0x8e4(%edx),%edx
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 539:	ff 24 85 8c 08 00 00 	jmp    *0x88c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 82 08 00 00       	mov    $0x882,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 ac 0b 00 00       	mov    0xbac,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 ac 0b 00 00    	mov    %edx,0xbac
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 ac 0b 00 00    	mov    %edx,0xbac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d ac 0b 00 00    	mov    0xbac,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d ac 0b 00 00    	mov    0xbac,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 ac 0b 00 00    	mov    0xbac,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 ac 0b 00 00    	mov    %edx,0xbac
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 ac 0b 00 00 b0 	movl   $0xbb0,0xbac
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf b0 0b 00 00       	mov    $0xbb0,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 b0 0b 00 00 b0 	movl   $0xbb0,0xbb0
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 b4 0b 00 00 00 	movl   $0x0,0xbb4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
