...
{
  12:	51                   	push   %ecx
  13:	83 ec 44             	sub    $0x44,%esp
  setprio(1000);
  16:	68 e8 03 00 00       	push   $0x3e8
  1b:	e8 7b 04 00 00       	call   49b <setprio>
  printf(1, "Priority of parent process = %d\n", getprio());
  20:	e8 7e 04 00 00       	call   4a3 <getprio>
  25:	83 c4 0c             	add    $0xc,%esp
  28:	50                   	push   %eax
  29:	68 20 09 00 00       	push   $0x920
  2e:	6a 01                	push   $0x1
  ...
  35:	83 c4 10             	add    $0x10,%esp
      ...
      int ret = fork();
  38:	e8 8e 03 00 00       	call   3cb <fork>
      if (ret == 0)
  ...
  45:	0f 8e a5 00 00 00    	jle    f0 <main+0xf0>
        {
	  pids[i] = ret;
  4b:	89 44 9d c0          	mov    %eax,-0x40(%ebp,%ebx,4)
  for (int i = 0; i < N; i++)
  4f:	83 c3 01             	add    $0x1,%ebx
  52:	83 fb 05             	cmp    $0x5,%ebx
  55:	75 e1                	jne    38 <main+0x38>
  57:	8d 75 d4             	lea    -0x2c(%ebp),%esi
  5a:	8d 7d e8             	lea    -0x18(%ebp),%edi
  ...
  for (int i = 0; i < N; i++)
    {
      rets[i] = wait();
  5f:	e8 77 03 00 00       	call   3db <wait>
  for (int i = 0; i < N; i++)
  64:	83 c3 04             	add    $0x4,%ebx
      rets[i] = wait();
  67:	89 43 fc             	mov    %eax,-0x4(%ebx)
  for (int i = 0; i < N; i++)
  ...
  printf(1, "\nAll children completed\n");
  73:	68 e2 08 00 00       	push   $0x8e2
  78:	6a 01                	push   $0x1
  7a:	e8 11 05 00 00       	call   590 <printf>
  7f:	83 c4 10             	add    $0x10,%esp
    printf(1, "Child %d.    pid %d\n", i, pids[i]);
  82:	ff 74 9d c0          	push   -0x40(%ebp,%ebx,4)
  86:	53                   	push   %ebx
  for (int i = 0; i < N; i++)
  ...
  8f:	6a 01                	push   $0x1
  91:	e8 fa 04 00 00       	call   590 <printf>
  for (int i = 0; i < N; i++)
  ...
  a1:	68 10 09 00 00       	push   $0x910
  a6:	6a 01                	push   $0x1
  a8:	e8 e3 04 00 00       	call   590 <printf>
  ...
  exit();
  cb:	e8 03 03 00 00       	call   3d3 <exit>
      int priority = 10*i + 1 ;
  d0:	6b db 0a             	imul   $0xa,%ebx,%ebx
	  setprio(priority);
  ...
  d6:	83 c3 01             	add    $0x1,%ebx
	  setprio(priority);
  d9:	53                   	push   %ebx
  da:	e8 bc 03 00 00       	call   49b <setprio>
	  delay(20);
  df:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
  e6:	e8 25 00 00 00       	call   110 <delay>
	  exit();
  eb:	e8 e3 02 00 00       	call   3d3 <exit>
	  printf(1, "fork error \n");
  f0:	50                   	push   %eax
  f1:	50                   	push   %eax
  f2:	68 d5 08 00 00       	push   $0x8d5
  f7:	6a 01                	push   $0x1
  f9:	e8 92 04 00 00       	call   590 <printf>
	  exit();
  fe:	e8 d0 02 00 00       	call   3d3 <exit>
...
00000110 <delay>:
{
 ...
 119:	8b 7d 08             	mov    0x8(%ebp),%edi
    data = (int *)malloc(sizeof(int) * 1024 * 10);
 11c:	68 00 a0 00 00       	push   $0xa000
 121:	e8 9a 06 00 00       	call   7c0 <malloc>
    if (data <= 0)
 ...
 12d:	74 37                	je     166 <delay+0x56>
    for (i = 0; i < count; i++)
 12f:	31 f6                	xor    %esi,%esi
 131:	8d 93 00 a0 00 00    	lea    0xa000(%ebx),%edx
 137:	85 ff                	test   %edi,%edi
 139:	7e 23                	jle    15e <delay+0x4e>
{
 13b:	b9 44 16 00 00       	mov    $0x1644,%ecx
            for (j = 0; j < 1024 * 10; j++)
 140:	89 d8                	mov    %ebx,%eax
 142:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
                data[j]++;
 148:	83 00 01             	addl   $0x1,(%eax)
            for (j = 0; j < 1024 * 10; j++)
 14b:	83 c0 04             	add    $0x4,%eax
 14e:	39 d0                	cmp    %edx,%eax
 150:	75 f6                	jne    148 <delay+0x38>
        for (k = 0; k < 5700; k++)
 152:	83 e9 01             	sub    $0x1,%ecx
 155:	75 e9                	jne    140 <delay+0x30>
    for (i = 0; i < count; i++)
 157:	83 c6 01             	add    $0x1,%esi
 15a:	39 f7                	cmp    %esi,%edi
 15c:	75 dd                	jne    13b <delay+0x2b>
}
 ...
 599:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 609:	ff 24 85 48 09 00 00 	jmp    *0x948(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 717:	90                   	nop
          s = "(null)";
 718:	ba 41 09 00 00       	mov    $0x941,%edx
        while(*s != 0){
