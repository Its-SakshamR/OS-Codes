...
_helloyou:     file format elf32-i386
...
int main(void)
{
  ...
  20:	e8 16 03 00 00       	call   33b <helloYou>
        helloYou("Welcome to XV6\n");
  25:	c7 04 24 8a 07 00 00 	movl   $0x78a,(%esp)
  2c:	e8 0a 03 00 00       	call   33b <helloYou>
    for (int i = 0; i < 10; i++){
  31:	83 c4 10             	add    $0x10,%esp
  34:	83 eb 01             	sub    $0x1,%ebx
  37:	75 df                	jne    18 <main+0x18>
    }
    exit();
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 495:	57                   	push   %edi
 496:	56                   	push   %esi
 497:	e8 17 fe ff ff       	call   2b3 <write>
 ...
 4c9:	ff 24 85 a4 07 00 00 	jmp    *0x7a4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 4ee:	e8 c0 fd ff ff       	call   2b3 <write>
        putc(fd, c);
 ...
 4ff:	57                   	push   %edi
 500:	56                   	push   %esi
 501:	e8 ad fd ff ff       	call   2b3 <write>
        putc(fd, c);
 ...
 5ac:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5af:	e8 ff fc ff ff       	call   2b3 <write>
        ap++;
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 9a 07 00 00       	mov    $0x79a,%edx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6e3:	e8 33 fc ff ff       	call   31b <sbrk>
  if(p == (char*)-1)
