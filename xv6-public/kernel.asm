...
801002a0:	e8 ab 44 00 00       	call   80104750 <acquire>
  while(n > 0){
...
801002f6:	e8 f5 43 00 00       	call   801046f0 <release>
        ilock(ip);
801002fb:	5a                   	pop    %edx
...
8010034c:	e8 9f 43 00 00       	call   801046f0 <release>
  ilock(ip);
80100351:	58                   	pop    %eax
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 16 81 10 80 	movl   $0x80108116,(%esp)
...
80100551:	e8 5a 43 00 00       	call   801048b0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 a5 42 00 00       	call   80104810 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 a0 41 00 00       	call   80104750 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 07 41 00 00       	call   801046f0 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 63 3f 00 00       	call   80104750 <acquire>
...
8010085b:	e8 90 3e 00 00       	call   801046f0 <release>
...
80100893:	e8 b8 3e 00 00       	call   80104750 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 1b 3d 00 00       	call   801046f0 <release>
  if(doprocdump) {
...
80100cd3:	e8 38 3d 00 00       	call   80104a10 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 24 3d 00 00       	call   80104a10 <strlen>
...
80100da1:	e8 2a 3c 00 00       	call   801049d0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 5b 37 00 00       	call   80104580 <initlock>
}
...
80100e41:	e8 0a 39 00 00       	call   80104750 <acquire>
...
80100e71:	e8 7a 38 00 00       	call   801046f0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 61 38 00 00       	call   801046f0 <release>
}
...
80100eaf:	e8 9c 38 00 00       	call   80104750 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 1f 38 00 00       	call   801046f0 <release>
  return f;
}
...
80100f01:	e8 4a 38 00 00       	call   80104750 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 af 37 00 00       	call   801046f0 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 7d 37 00 00       	jmp    801046f0 <release>
...
80101325:	e8 e6 34 00 00       	call   80104810 <memset>
  log_write(bp);
...
8010136a:	e8 e1 33 00 00       	call   80104750 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 14 33 00 00       	call   801046f0 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 e6 32 00 00       	call   801046f0 <release>
      return ip;
...
80101541:	e8 6a 33 00 00       	call   801048b0 <memmove>
  brelse(bp);
...
80101576:	e8 05 30 00 00       	call   80104580 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 bc 2e 00 00       	call   80104450 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 ef 32 00 00       	call   801048b0 <memmove>
  brelse(bp);
...
8010168e:	e8 7d 31 00 00       	call   80104810 <memset>
      dip->type = type;
...
80101731:	e8 7a 31 00 00       	call   801048b0 <memmove>
  log_write(bp);
...
8010175f:	e8 ec 2f 00 00       	call   80104750 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010176f:	e8 7c 2f 00 00       	call   801046f0 <release>
}
...
801017a2:	e8 e9 2c 00 00       	call   80104490 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 93 30 00 00       	call   801048b0 <memmove>
    brelse(bp);
...
80101873:	e8 b8 2c 00 00       	call   80104530 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 5c 2c 00 00       	jmp    801044f0 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 cb 2b 00 00       	call   80104490 <acquiresleep>
...
801018da:	e8 11 2c 00 00       	call   801044f0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
801018e6:	e8 65 2e 00 00       	call   80104750 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 eb 2d 00 00       	jmp    801046f0 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 09 11 80       	push   $0x80110960
80101910:	e8 3b 2e 00 00       	call   80104750 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
8010191f:	e8 cc 2d 00 00       	call   801046f0 <release>
    if(r == 1){
...
80101a23:	e8 08 2b 00 00       	call   80104530 <holdingsleep>
...
80101a3a:	e8 b1 2a 00 00       	call   801044f0 <releasesleep>
  iput(ip);
...
80101b37:	e8 74 2d 00 00       	call   801048b0 <memmove>
    brelse(bp);
...
80101c33:	e8 78 2c 00 00       	call   801048b0 <memmove>
    log_write(bp);
...
80101cce:	e8 4d 2c 00 00       	call   80104920 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 ee 2b 00 00       	call   80104920 <strncmp>
      continue;
...
80101dba:	e8 91 29 00 00       	call   80104750 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 09 11 80 	movl   $0x80110960,(%esp)
80101dca:	e8 21 29 00 00       	call   801046f0 <release>
...
80101e27:	e8 84 2a 00 00       	call   801048b0 <memmove>
...
80101e8c:	e8 9f 26 00 00       	call   80104530 <holdingsleep>
...
80101eae:	e8 3d 26 00 00       	call   801044f0 <releasesleep>
  iput(ip);
...
80101edb:	e8 d0 29 00 00       	call   801048b0 <memmove>
    name[len] = 0;
...
80101f2b:	e8 00 26 00 00       	call   80104530 <holdingsleep>
...
80101f4a:	e8 a1 25 00 00       	call   801044f0 <releasesleep>
  iput(ip);
...
80101f6d:	e8 be 25 00 00       	call   80104530 <holdingsleep>
...
80101f90:	e8 9b 25 00 00       	call   80104530 <holdingsleep>
...
80101fa7:	e8 44 25 00 00       	call   801044f0 <releasesleep>
}
...
8010203d:	e8 2e 29 00 00       	call   80104970 <strncpy>
...
801021d0:	e8 ab 23 00 00       	call   80104580 <initlock>
...
8010224e:	e8 fd 24 00 00       	call   80104750 <acquire>
...
801022cb:	e8 20 24 00 00       	call   801046f0 <release>
...
801022ee:	e8 3d 22 00 00       	call   80104530 <holdingsleep>
...
80102328:	e8 23 24 00 00       	call   80104750 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 65 23 00 00       	jmp    801046f0 <release>
...
801024f2:	e8 19 23 00 00       	call   80104810 <memset>
...
80102528:	e8 23 22 00 00       	call   80104750 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 a8 21 00 00       	jmp    801046f0 <release>
    panic("kfree");
...
80102625:	e8 56 1f 00 00       	call   80104580 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 98 20 00 00       	call   80104750 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 0a 20 00 00       	call   801046f0 <release>
  return (char*)r;
...
80102af7:	e8 64 1d 00 00       	call   80104860 <memcmp>
...
80102c24:	e8 87 1c 00 00       	call   801048b0 <memmove>
...
80102cd4:	e8 a7 18 00 00       	call   80104580 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 e0 19 00 00       	call   80104750 <acquire>
...
80102d85:	e8 26 13 00 00       	call   801040b0 <sleep>
...
80102dbc:	e8 2f 19 00 00       	call   801046f0 <release>
      break;
    }
  }
}
...
80102dde:	e8 6d 19 00 00       	call   80104750 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 cf 18 00 00       	call   801046f0 <release>
}
...
80102e36:	e8 15 19 00 00       	call   80104750 <acquire>
    wakeup(&log);
...
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 1f 13 00 00       	call   80104170 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102e58:	e8 93 18 00 00       	call   801046f0 <release>
...
80102eb4:	e8 f7 19 00 00       	call   801048b0 <memmove>
...
80102f08:	e8 63 12 00 00       	call   80104170 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 26 11 80 	movl   $0x801126a0,(%esp)
80102f14:	e8 d7 17 00 00       	call   801046f0 <release>
...
80102f76:	e8 d5 17 00 00       	call   80104750 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 36 17 00 00       	jmp    801046f0 <release>
...
801030d4:	e8 d7 17 00 00       	call   801048b0 <memmove>
...
801031c4:	e8 97 16 00 00       	call   80104860 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 dc 15 00 00       	call   80104860 <memcmp>
...
801033c8:	e8 93 14 00 00       	call   80104860 <memcmp>
...
801034a9:	e8 d2 10 00 00       	call   80104580 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 0c 12 00 00       	call   80104750 <acquire>
  if(writable){
...
8010355f:	e8 0c 0c 00 00       	call   80104170 <wakeup>
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 67 11 00 00       	jmp    801046f0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 57 11 00 00       	call   801046f0 <release>
    kfree((char*)p);
...
801035c4:	e8 a7 0b 00 00       	call   80104170 <wakeup>
...
801035dd:	e8 6e 11 00 00       	call   80104750 <acquire>
  for(i = 0; i < n; i++){
...
80103638:	e8 33 0b 00 00       	call   80104170 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
8010363d:	58                   	pop    %eax
8010363e:	5a                   	pop    %edx
8010363f:	53                   	push   %ebx
80103640:	56                   	push   %esi
80103641:	e8 6a 0a 00 00       	call   801040b0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010366c:	e8 7f 10 00 00       	call   801046f0 <release>
        return -1;
...
801036ba:	e8 b1 0a 00 00       	call   80104170 <wakeup>
  release(&p->lock);
801036bf:	89 1c 24             	mov    %ebx,(%esp)
801036c2:	e8 29 10 00 00       	call   801046f0 <release>
  return n;
...
801036e6:	e8 65 10 00 00       	call   80104750 <acquire>
...
80103715:	e8 96 09 00 00       	call   801040b0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103776:	e8 f5 09 00 00       	call   80104170 <wakeup>
  release(&p->lock);
8010377b:	89 34 24             	mov    %esi,(%esp)
8010377e:	e8 6d 0f 00 00       	call   801046f0 <release>
  return i;
...
80103799:	e8 52 0f 00 00       	call   801046f0 <release>
      return -1;
...
801037c1:	e8 8a 0f 00 00       	call   80104750 <acquire>
...
80103802:	8d 50 01             	lea    0x1(%eax),%edx
  p->prio = 500;
80103805:	c7 83 80 00 00 00 f4 	movl   $0x1f4,0x80(%ebx)
8010380c:	01 00 00 
  p->welcome_addr = 0;
...
80103828:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
8010382e:	e8 bd 0e 00 00       	call   801046f0 <release>
...
80103850:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103853:	c7 40 14 33 5c 10 80 	movl   $0x80105c33,0x14(%eax)
  p->context = (struct context*)sp;
...
80103862:	e8 a9 0f 00 00       	call   80104810 <memset>
...
8010388a:	e8 61 0e 00 00       	call   801046f0 <release>
}
...
801038bb:	e8 30 0e 00 00       	call   801046f0 <release>
...
80103906:	68 00 7c 10 80       	push   $0x80107c00
8010390b:	68 20 2d 11 80       	push   $0x80112d20
80103910:	e8 6b 0c 00 00       	call   80104580 <initlock>
}
...
801039a4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801039a7:	e8 54 0c 00 00       	call   80104600 <pushcli>
  c = mycpu();
801039ac:	e8 6f ff ff ff       	call   80103920 <mycpu>
  p = c->proc;
801039b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b7:	e8 94 0c 00 00       	call   80104650 <popcli>
}
...
801039dc:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039de:	a3 54 50 11 80       	mov    %eax,0x80115054
  if((p->pgdir = setupkvm()) == 0)
801039e3:	e8 88 38 00 00       	call   80107270 <setupkvm>
...
80103a01:	e8 1a 35 00 00       	call   80106f20 <inituvm>
...
80103a16:	e8 f5 0d 00 00       	call   80104810 <memset>
...
80103a6f:	68 30 7c 10 80       	push   $0x80107c30
80103a74:	50                   	push   %eax
80103a75:	e8 56 0f 00 00       	call   801049d0 <safestrcpy>
  p->cwd = namei("/");
80103a7a:	c7 04 24 39 7c 10 80 	movl   $0x80107c39,(%esp)
...
80103ab3:	68 17 7c 10 80       	push   $0x80107c17
...
80103ac5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103ac8:	e8 33 0b 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103acd:	e8 4e fe ff ff       	call   80103920 <mycpu>
  p = c->proc;
80103ad2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ad8:	e8 73 0b 00 00       	call   80104650 <popcli>
  sz = curproc->sz;
...
80103aeb:	e8 20 33 00 00       	call   80106e10 <switchuvm>
  return 0;
...
80103b0a:	e8 81 35 00 00       	call   80107090 <allocuvm>
...
80103b2a:	e8 91 36 00 00       	call   801071c0 <deallocuvm>
...
80103b46:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b49:	e8 b2 0a 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103b4e:	e8 cd fd ff ff       	call   80103920 <mycpu>
  p = c->proc;
80103b53:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b59:	e8 f2 0a 00 00       	call   80104650 <popcli>
  if((np = allocproc()) == 0){
...
80103b78:	e8 e3 37 00 00       	call   80107360 <copyuvm>
...
80103ba9:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  np->return_addr = (char*)(curproc->tf->eip);
80103bb0:	8b 43 18             	mov    0x18(%ebx),%eax
80103bb3:	8b 40 38             	mov    0x38(%eax),%eax
80103bb6:	89 81 88 00 00 00    	mov    %eax,0x88(%ecx)
  if(curproc->welcome_addr){
80103bbc:	8b 83 84 00 00 00    	mov    0x84(%ebx),%eax
80103bc2:	85 c0                	test   %eax,%eax
80103bc4:	74 06                	je     80103bcc <fork+0x8c>
    np->tf->eip = (uint)(curproc->welcome_addr);
80103bc6:	8b 51 18             	mov    0x18(%ecx),%edx
80103bc9:	89 42 38             	mov    %eax,0x38(%edx)
{
...
80103ca1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca4:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
80103ca9:	68 20 2d 11 80       	push   $0x80112d20
80103cae:	e8 9d 0a 00 00       	call   80104750 <acquire>
      if(p->state != RUNNABLE || p->prio < prio_check)
80103cb3:	8b 15 08 b0 10 80    	mov    0x8010b008,%edx
80103cb9:	83 c4 10             	add    $0x10,%esp
80103cbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cc0:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cc4:	75 45                	jne    80103d0b <scheduler+0x8b>
80103cc6:	39 97 80 00 00 00    	cmp    %edx,0x80(%edi)
80103ccc:	7c 3d                	jl     80103d0b <scheduler+0x8b>
      switchuvm(p);
80103cce:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103cd1:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103cd7:	57                   	push   %edi
80103cd8:	e8 33 31 00 00       	call   80106e10 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103cdd:	58                   	pop    %eax
80103cde:	5a                   	pop    %edx
80103cdf:	ff 77 1c             	push   0x1c(%edi)
80103ce2:	56                   	push   %esi
      p->inctxt += 1;
80103ce3:	83 47 7c 01          	addl   $0x1,0x7c(%edi)
      p->state = RUNNING;
80103ce7:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103cee:	e8 38 0d 00 00       	call   80104a2b <swtch>
      switchkvm();
80103cf3:	e8 08 31 00 00       	call   80106e00 <switchkvm>
    prio_check -= 10;
80103cf8:	8b 15 08 b0 10 80    	mov    0x8010b008,%edx
80103cfe:	83 c4 10             	add    $0x10,%esp
      c->proc = 0;
80103d01:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103d08:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d0b:	81 c7 8c 00 00 00    	add    $0x8c,%edi
80103d11:	81 ff 54 50 11 80    	cmp    $0x80115054,%edi
80103d17:	75 a7                	jne    80103cc0 <scheduler+0x40>
    if(prio_check < 0){
80103d19:	83 ea 0a             	sub    $0xa,%edx
80103d1c:	b8 e8 03 00 00       	mov    $0x3e8,%eax
80103d21:	0f 48 d0             	cmovs  %eax,%edx
    release(&ptable.lock);
80103d24:	83 ec 0c             	sub    $0xc,%esp
80103d27:	68 20 2d 11 80       	push   $0x80112d20
    prio_check -= 10;
80103d2c:	89 15 08 b0 10 80    	mov    %edx,0x8010b008
    release(&ptable.lock);
80103d32:	e8 b9 09 00 00       	call   801046f0 <release>
    sti();
80103d37:	83 c4 10             	add    $0x10,%esp
80103d3a:	e9 61 ff ff ff       	jmp    80103ca0 <scheduler+0x20>
80103d3f:	90                   	nop
...
80103d44:	53                   	push   %ebx
  pushcli();
80103d45:	e8 b6 08 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103d4a:	e8 d1 fb ff ff       	call   80103920 <mycpu>
  p = c->proc;
...
80103d6c:	74 4f                	je     80103dbd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103d6e:	e8 ad fb ff ff       	call   80103920 <mycpu>
...
80103d87:	75 41                	jne    80103dca <sched+0x8a>
  intena = mycpu()->intena;
80103d89:	e8 92 fb ff ff       	call   80103920 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103d8e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103d91:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d97:	e8 84 fb ff ff       	call   80103920 <mycpu>
...
80103da3:	e8 83 0c 00 00       	call   80104a2b <swtch>
  mycpu()->intena = intena;
80103da8:	e8 73 fb ff ff       	call   80103920 <mycpu>
}
...
80103e06:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103e09:	e8 92 fb ff ff       	call   801039a0 <myproc>
  if(curproc == initproc)
...
80103e6a:	e8 e1 08 00 00       	call   80104750 <acquire>
...
80103f17:	68 88 7c 10 80       	push   $0x80107c88
80103f1c:	e8 5f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f21:	83 ec 0c             	sub    $0xc,%esp
80103f24:	68 7b 7c 10 80       	push   $0x80107c7b
...
80103f52:	e8 f9 07 00 00       	call   80104750 <acquire>
...
80103f96:	0f 84 9a 00 00 00    	je     80104036 <wait+0x106>
80103f9c:	8b 46 24             	mov    0x24(%esi),%eax
80103f9f:	85 c0                	test   %eax,%eax
80103fa1:	0f 85 8f 00 00 00    	jne    80104036 <wait+0x106>
  pushcli();
80103fa7:	e8 54 06 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103fac:	e8 6f f9 ff ff       	call   80103920 <mycpu>
  p = c->proc;
80103fb1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fb7:	e8 94 06 00 00       	call   80104650 <popcli>
  if(p == 0)
80103fbc:	85 db                	test   %ebx,%ebx
80103fbe:	0f 84 89 00 00 00    	je     8010404d <wait+0x11d>
  p->chan = chan;
80103fc4:	89 73 20             	mov    %esi,0x20(%ebx)
  p->state = SLEEPING;
80103fc7:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103fce:	e8 6d fd ff ff       	call   80103d40 <sched>
  p->chan = 0;
80103fd3:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80103fda:	e9 7b ff ff ff       	jmp    80103f5a <wait+0x2a>
80103fdf:	90                   	nop
        kfree(p->kstack);
...
80103fe9:	e8 d2 e4 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
80103fee:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ff5:	5a                   	pop    %edx
80103ff6:	ff 73 04             	push   0x4(%ebx)
80103ff9:	e8 f2 31 00 00       	call   801071f0 <freevm>
        p->pid = 0;
...
80104025:	e8 c6 06 00 00       	call   801046f0 <release>
        return pid;
...
80104067:	68 20 2d 11 80       	push   $0x80112d20
8010406c:	e8 df 06 00 00       	call   80104750 <acquire>
  pushcli();
80104071:	e8 8a 05 00 00       	call   80104600 <pushcli>
  c = mycpu();
80104076:	e8 a5 f8 ff ff       	call   80103920 <mycpu>
  p = c->proc;
8010407b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104081:	e8 ca 05 00 00       	call   80104650 <popcli>
...
80104099:	e8 52 06 00 00       	call   801046f0 <release>
}
...
801040bc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040bf:	e8 3c 05 00 00       	call   80104600 <pushcli>
  c = mycpu();
801040c4:	e8 57 f8 ff ff       	call   80103920 <mycpu>
  p = c->proc;
801040c9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040cf:	e8 7c 05 00 00       	call   80104650 <popcli>
  if(p == 0)
...
801040e0:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
801040e6:	74 50                	je     80104138 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
801040e8:	83 ec 0c             	sub    $0xc,%esp
801040eb:	68 20 2d 11 80       	push   $0x80112d20
801040f0:	e8 5b 06 00 00       	call   80104750 <acquire>
    release(lk);
801040f5:	89 34 24             	mov    %esi,(%esp)
801040f8:	e8 f3 05 00 00       	call   801046f0 <release>
  p->chan = chan;
...
8010410c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80104113:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010411a:	e8 d1 05 00 00       	call   801046f0 <release>
    acquire(lk);
...
8010412b:	5d                   	pop    %ebp
    acquire(lk);
8010412c:	e9 1f 06 00 00       	jmp    80104750 <acquire>
...
80104159:	68 9a 7c 10 80       	push   $0x80107c9a
8010415e:	e8 1d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104163:	83 ec 0c             	sub    $0xc,%esp
80104166:	68 94 7c 10 80       	push   $0x80107c94
...
8010417f:	e8 cc 05 00 00       	call   80104750 <acquire>
...
80104195:	3d 54 50 11 80       	cmp    $0x80115054,%eax
8010419a:	74 1e                	je     801041ba <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
...
801041a7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ae:	05 8c 00 00 00       	add    $0x8c,%eax
801041b3:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801041b8:	75 e2                	jne    8010419c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
801041ba:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
801041c1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041c4:	c9                   	leave  
  release(&ptable.lock);
801041c5:	e9 26 05 00 00       	jmp    801046f0 <release>
...
801041df:	e8 6c 05 00 00       	call   80104750 <acquire>
801041e4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041e7:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801041ec:	eb 0e                	jmp    801041fc <kill+0x2c>
801041ee:	66 90                	xchg   %ax,%ax
801041f0:	05 8c 00 00 00       	add    $0x8c,%eax
801041f5:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801041fa:	74 34                	je     80104230 <kill+0x60>
    if(p->pid == pid){
...
8010421d:	e8 ce 04 00 00       	call   801046f0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104233:	68 20 2d 11 80       	push   $0x80112d20
80104238:	e8 b3 04 00 00       	call   801046f0 <release>
}
...
8010426b:	68 16 81 10 80       	push   $0x80108116
80104270:	e8 2b c4 ff ff       	call   801006a0 <cprintf>
80104275:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104278:	81 c3 8c 00 00 00    	add    $0x8c,%ebx
8010427e:	81 fb c0 50 11 80    	cmp    $0x801150c0,%ebx
...
8010428f:	74 e7                	je     80104278 <procdump+0x28>
      state = "???";
80104291:	ba ab 7c 10 80       	mov    $0x80107cab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104296:	83 f8 05             	cmp    $0x5,%eax
80104299:	77 11                	ja     801042ac <procdump+0x5c>
8010429b:	8b 14 85 0c 7d 10 80 	mov    -0x7fef82f4(,%eax,4),%edx
      state = "???";
801042a2:	b8 ab 7c 10 80       	mov    $0x80107cab,%eax
801042a7:	85 d2                	test   %edx,%edx
801042a9:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801042ac:	53                   	push   %ebx
801042ad:	52                   	push   %edx
801042ae:	ff 73 a4             	push   -0x5c(%ebx)
801042b1:	68 af 7c 10 80       	push   $0x80107caf
801042b6:	e8 e5 c3 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
...
801042d8:	e8 c3 02 00 00       	call   801045a0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042ed:	68 01 77 10 80       	push   $0x80107701
...
80104316:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
80104319:	68 20 2d 11 80       	push   $0x80112d20
8010431e:	e8 2d 04 00 00       	call   80104750 <acquire>
80104323:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104326:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
...
80104334:	83 db ff             	sbb    $0xffffffff,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104337:	05 8c 00 00 00       	add    $0x8c,%eax
8010433c:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104341:	75 ed                	jne    80104330 <getNum+0x20>
    }
  }
  release(&ptable.lock);
...
80104363:	53                   	push   %ebx
  struct proc *p;
  int Pid=0;
80104364:	31 db                	xor    %ebx,%ebx
{
80104366:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
80104369:	68 20 2d 11 80       	push   $0x80112d20
8010436e:	e8 dd 03 00 00       	call   80104750 <acquire>
80104373:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104376:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
8010437b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010437f:	90                   	nop
    if(p -> pid > Pid){
80104380:	8b 50 10             	mov    0x10(%eax),%edx
80104383:	39 d3                	cmp    %edx,%ebx
80104385:	0f 4c da             	cmovl  %edx,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104388:	05 8c 00 00 00       	add    $0x8c,%eax
8010438d:	3d 54 50 11 80       	cmp    $0x80115054,%eax
80104392:	75 ec                	jne    80104380 <MaxPid+0x20>
      Pid = p -> pid;
    }
  }
  release(&ptable.lock);
...
8010439c:	e8 4f 03 00 00       	call   801046f0 <release>
  return Pid;
}
801043a1:	89 d8                	mov    %ebx,%eax
801043a3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043a6:	c9                   	leave  
801043a7:	c3                   	ret    
...
801043c3:	e8 88 03 00 00       	call   80104750 <acquire>
801043c8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043cb:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801043d0:	eb 12                	jmp    801043e4 <ProcInfo+0x34>
801043d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801043d8:	05 8c 00 00 00       	add    $0x8c,%eax
801043dd:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801043e2:	74 44                	je     80104428 <ProcInfo+0x78>
    if((p->pid == pid) && (p->state != UNUSED)){
801043e4:	39 58 10             	cmp    %ebx,0x10(%eax)
801043e7:	75 ef                	jne    801043d8 <ProcInfo+0x28>
801043e9:	8b 50 0c             	mov    0xc(%eax),%edx
801043ec:	85 d2                	test   %edx,%edx
801043ee:	74 e8                	je     801043d8 <ProcInfo+0x28>
      if(pid == 1){
        procinfo->ppid = 0;  
801043f0:	31 d2                	xor    %edx,%edx
      if(pid == 1){
801043f2:	83 fb 01             	cmp    $0x1,%ebx
801043f5:	74 06                	je     801043fd <ProcInfo+0x4d>
      }
      else{
        procinfo->ppid = (p->parent)->pid;
801043f7:	8b 50 14             	mov    0x14(%eax),%edx
801043fa:	8b 52 10             	mov    0x10(%edx),%edx
801043fd:	89 16                	mov    %edx,(%esi)
      }
      procinfo->psize = p->sz;
801043ff:	8b 10                	mov    (%eax),%edx
      procinfo->numberContextSwitches = p->inctxt;
      release(&ptable.lock);
80104401:	83 ec 0c             	sub    $0xc,%esp
      procinfo->psize = p->sz;
80104404:	89 56 04             	mov    %edx,0x4(%esi)
      procinfo->numberContextSwitches = p->inctxt;
80104407:	8b 40 7c             	mov    0x7c(%eax),%eax
8010440a:	89 46 08             	mov    %eax,0x8(%esi)
      release(&ptable.lock);
8010440d:	68 20 2d 11 80       	push   $0x80112d20
80104412:	e8 d9 02 00 00       	call   801046f0 <release>
      return 0;
...
8010441a:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return 0;
...
8010442b:	68 20 2d 11 80       	push   $0x80112d20
80104430:	e8 bb 02 00 00       	call   801046f0 <release>
  return -1;
80104435:	83 c4 10             	add    $0x10,%esp
}
80104438:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
...
8010445a:	68 24 7d 10 80       	push   $0x80107d24
...
8010449f:	e8 ac 02 00 00       	call   80104750 <acquire>
  while (lk->locked) {
...
801044b5:	e8 f6 fb ff ff       	call   801040b0 <sleep>
  while (lk->locked) {
...
801044c3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044c9:	e8 d2 f4 ff ff       	call   801039a0 <myproc>
...
801044dc:	5d                   	pop    %ebp
  release(&lk->lk);
801044dd:	e9 0e 02 00 00       	jmp    801046f0 <release>
...
801044ff:	e8 4c 02 00 00       	call   80104750 <acquire>
  lk->locked = 0;
...
80104514:	e8 57 fc ff ff       	call   80104170 <wakeup>
  release(&lk->lk);
...
80104524:	5d                   	pop    %ebp
  release(&lk->lk);
80104525:	e9 c6 01 00 00       	jmp    801046f0 <release>
...
80104542:	e8 09 02 00 00       	call   80104750 <acquire>
...
80104554:	e8 97 01 00 00       	call   801046f0 <release>
  return r;
}
...
8010456b:	e8 30 f4 ff ff       	call   801039a0 <myproc>
...
801045db:	8d 51 28             	lea    0x28(%ecx),%edx
...
80104609:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010460a:	e8 11 f3 ff ff       	call   80103920 <mycpu>
8010460f:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
80104615:	85 c0                	test   %eax,%eax
80104617:	74 17                	je     80104630 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104619:	e8 02 f3 ff ff       	call   80103920 <mycpu>
8010461e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104641:	eb d6                	jmp    80104619 <pushcli+0x19>
...
80104695:	68 2f 7d 10 80       	push   $0x80107d2f
8010469a:	e8 e1 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010469f:	83 ec 0c             	sub    $0xc,%esp
801046a2:	68 46 7d 10 80       	push   $0x80107d46
...
801046c3:	75 0b                	jne    801046d0 <holding+0x20>
  popcli();
801046c5:	e8 86 ff ff ff       	call   80104650 <popcli>
}
...
801046cf:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
801046d0:	8b 5e 08             	mov    0x8(%esi),%ebx
801046d3:	e8 48 f2 ff ff       	call   80103920 <mycpu>
801046d8:	39 c3                	cmp    %eax,%ebx
801046da:	0f 94 c3             	sete   %bl
  popcli();
801046dd:	e8 6e ff ff ff       	call   80104650 <popcli>
  r = lock->locked && lock->cpu == mycpu();
801046e2:	0f b6 db             	movzbl %bl,%ebx
}
801046e5:	89 d8                	mov    %ebx,%eax
801046e7:	5b                   	pop    %ebx
801046e8:	5e                   	pop    %esi
801046e9:	5d                   	pop    %ebp
801046ea:	c3                   	ret    
...
801046f5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
801046f8:	e8 03 ff ff ff       	call   80104600 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801046fd:	8b 03                	mov    (%ebx),%eax
801046ff:	85 c0                	test   %eax,%eax
80104701:	75 15                	jne    80104718 <release+0x28>
  popcli();
80104703:	e8 48 ff ff ff       	call   80104650 <popcli>
    panic("release");
80104708:	83 ec 0c             	sub    $0xc,%esp
8010470b:	68 4d 7d 10 80       	push   $0x80107d4d
80104710:	e8 6b bc ff ff       	call   80100380 <panic>
80104715:	8d 76 00             	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104718:	8b 73 08             	mov    0x8(%ebx),%esi
8010471b:	e8 00 f2 ff ff       	call   80103920 <mycpu>
80104720:	39 c6                	cmp    %eax,%esi
80104722:	75 df                	jne    80104703 <release+0x13>
  popcli();
80104724:	e8 27 ff ff ff       	call   80104650 <popcli>
  lk->pcs[0] = 0;
80104729:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104730:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80104737:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
8010473c:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
80104742:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104745:	5b                   	pop    %ebx
80104746:	5e                   	pop    %esi
80104747:	5d                   	pop    %ebp
  popcli();
80104748:	e9 03 ff ff ff       	jmp    80104650 <popcli>
...
80104757:	e8 a4 fe ff ff       	call   80104600 <pushcli>
  if(holding(lk))
8010475c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010475f:	e8 9c fe ff ff       	call   80104600 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80104764:	8b 03                	mov    (%ebx),%eax
80104766:	85 c0                	test   %eax,%eax
80104768:	75 7e                	jne    801047e8 <acquire+0x98>
  popcli();
8010476a:	e8 e1 fe ff ff       	call   80104650 <popcli>
  asm volatile("lock; xchgl %0, %1" :
8010476f:	b9 01 00 00 00       	mov    $0x1,%ecx
...
80104782:	75 f4                	jne    80104778 <acquire+0x28>
  __sync_synchronize();
80104784:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104789:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010478c:	e8 8f f1 ff ff       	call   80103920 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104791:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
80104794:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
80104796:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
...
801047ac:	77 1a                	ja     801047c8 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
801047ae:	8b 5a 04             	mov    0x4(%edx),%ebx
801047b1:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
801047b5:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
801047b8:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
801047ba:	83 f8 0a             	cmp    $0xa,%eax
801047bd:	75 e1                	jne    801047a0 <acquire+0x50>
}
...
801047c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
801047c8:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
801047cc:	8d 51 34             	lea    0x34(%ecx),%edx
801047cf:	90                   	nop
    pcs[i] = 0;
...
801047e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
801047e8:	8b 5b 08             	mov    0x8(%ebx),%ebx
801047eb:	e8 30 f1 ff ff       	call   80103920 <mycpu>
801047f0:	39 c3                	cmp    %eax,%ebx
801047f2:	0f 85 72 ff ff ff    	jne    8010476a <acquire+0x1a>
  popcli();
801047f8:	e8 53 fe ff ff       	call   80104650 <popcli>
    panic("acquire");
801047fd:	83 ec 0c             	sub    $0xc,%esp
80104800:	68 55 7d 10 80       	push   $0x80107d55
...
80104820:	09 cf                	or     %ecx,%edi
80104822:	83 e7 03             	and    $0x3,%edi
80104825:	75 29                	jne    80104850 <memset+0x40>
    c &= 0xFF;
80104827:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010482a:	c1 e0 18             	shl    $0x18,%eax
8010482d:	89 fb                	mov    %edi,%ebx
8010482f:	c1 e9 02             	shr    $0x2,%ecx
80104832:	c1 e3 10             	shl    $0x10,%ebx
80104835:	09 d8                	or     %ebx,%eax
80104837:	09 f8                	or     %edi,%eax
80104839:	c1 e7 08             	shl    $0x8,%edi
8010483c:	09 f8                	or     %edi,%eax
}
...
80104840:	fc                   	cld    
80104841:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104843:	5b                   	pop    %ebx
80104844:	89 d0                	mov    %edx,%eax
80104846:	5f                   	pop    %edi
80104847:	5d                   	pop    %ebp
80104848:	c3                   	ret    
...
801048ce:	74 0c                	je     801048dc <memmove+0x2c>
      *--d = *--s;
...
801048e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
801048e8:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
...
80104930:	74 2e                	je     80104960 <strncmp+0x40>
80104932:	01 d6                	add    %edx,%esi
80104934:	eb 18                	jmp    8010494e <strncmp+0x2e>
80104936:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010493d:	8d 76 00             	lea    0x0(%esi),%esi
80104940:	38 d8                	cmp    %bl,%al
80104942:	75 14                	jne    80104958 <strncmp+0x38>
    n--, p++, q++;
80104944:	83 c2 01             	add    $0x1,%edx
80104947:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010494a:	39 f2                	cmp    %esi,%edx
8010494c:	74 12                	je     80104960 <strncmp+0x40>
8010494e:	0f b6 01             	movzbl (%ecx),%eax
80104951:	0f b6 1a             	movzbl (%edx),%ebx
80104954:	84 c0                	test   %al,%al
80104956:	75 e8                	jne    80104940 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104958:	29 d8                	sub    %ebx,%eax
}
8010495a:	5b                   	pop    %ebx
8010495b:	5e                   	pop    %esi
8010495c:	5d                   	pop    %ebp
...
80104979:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;
...
8010498a:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
8010498e:	88 50 ff             	mov    %dl,-0x1(%eax)
80104991:	84 d2                	test   %dl,%dl
80104993:	74 09                	je     8010499e <strncpy+0x2e>
80104995:	89 cb                	mov    %ecx,%ebx
80104997:	83 e9 01             	sub    $0x1,%ecx
...
801049a2:	7e 17                	jle    801049bb <strncpy+0x4b>
801049a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
801049a8:	83 c2 01             	add    $0x1,%edx
801049ab:	89 c1                	mov    %eax,%ecx
801049ad:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
801049b1:	29 d1                	sub    %edx,%ecx
801049b3:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
801049b7:	85 c9                	test   %ecx,%ecx
801049b9:	7f ed                	jg     801049a8 <strncpy+0x38>
  return os;
}
801049bb:	5b                   	pop    %ebx
...
80104a87:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104a8a:	e8 11 ef ff ff       	call   801039a0 <myproc>

  if(addr >= curproc->sz)
80104a8f:	39 18                	cmp    %ebx,(%eax)
80104a91:	76 2d                	jbe    80104ac0 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104aad:	76 11                	jbe    80104ac0 <fetchstr+0x40>
    if(*s == 0)
...
80104ad5:	e8 c6 ee ff ff       	call   801039a0 <myproc>
...
80104ae3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ae6:	e8 b5 ee ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b26:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104b29:	e8 72 ee ff ff       	call   801039a0 <myproc>
80104b2e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b30:	e8 6b ee ff ff       	call   801039a0 <myproc>
...
80104b3e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b41:	e8 5a ee ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b62:	39 c2                	cmp    %eax,%edx
80104b64:	76 1a                	jbe    80104b80 <argptr+0x60>
...
80104b94:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b95:	e8 06 ee ff ff       	call   801039a0 <myproc>
...
80104ba3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ba6:	e8 f5 ed ff ff       	call   801039a0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104bbb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104bbe:	e8 dd ed ff ff       	call   801039a0 <myproc>
  if(addr >= curproc->sz)
...
80104be5:	76 11                	jbe    80104bf8 <argstr+0x68>
    if(*s == 0)
...
80104c14:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104c17:	e8 84 ed ff ff       	call   801039a0 <myproc>
...
80104c27:	83 fa 20             	cmp    $0x20,%edx
80104c2a:	77 24                	ja     80104c50 <syscall+0x40>
80104c2c:	8b 14 85 80 7d 10 80 	mov    -0x7fef8280(,%eax,4),%edx
...
80104c58:	68 5d 7d 10 80       	push   $0x80107d5d
80104c5d:	e8 3e ba ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
...
80104db4:	68 24 7e 10 80       	push   $0x80107e24
...
80104dcc:	68 23 7e 10 80       	push   $0x80107e23
...
80104de1:	68 17 7e 10 80       	push   $0x80107e17
...
80104dff:	68 26 7e 10 80       	push   $0x80107e26
80104e04:	e8 77 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104e09:	83 ec 0c             	sub    $0xc,%esp
80104e0c:	68 08 7e 10 80       	push   $0x80107e08
...
80104eae:	e8 1d fc ff ff       	call   80104ad0 <argint>
...
80104ed9:	e8 f2 fb ff ff       	call   80104ad0 <argint>
...
80104eee:	e8 2d fc ff ff       	call   80104b20 <argptr>
...
80104f2e:	e8 9d fb ff ff       	call   80104ad0 <argint>
...
80104f59:	e8 72 fb ff ff       	call   80104ad0 <argint>
...
80104f6e:	e8 ad fb ff ff       	call   80104b20 <argptr>
...
80104fae:	e8 1d fb ff ff       	call   80104ad0 <argint>
...
80104fd1:	74 25                	je     80104ff8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104fd3:	e8 c8 e9 ff ff       	call   801039a0 <myproc>
  fileclose(f);
...
8010500e:	e8 bd fa ff ff       	call   80104ad0 <argint>
...
80105020:	e8 7b e9 ff ff       	call   801039a0 <myproc>
...
80105038:	e8 e3 fa ff ff       	call   80104b20 <argptr>
...
8010507f:	e8 0c fb ff ff       	call   80104b90 <argstr>
...
80105098:	e8 f3 fa ff ff       	call   80104b90 <argstr>
...
801051b5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801051cf:	e8 bc f9 ff ff       	call   80104b90 <argstr>
...
8010520d:	58                   	pop    %eax
8010520e:	5a                   	pop    %edx
8010520f:	68 24 7e 10 80       	push   $0x80107e24
...
80105228:	68 23 7e 10 80       	push   $0x80107e23
...
801053af:	e8 dc f7 ff ff       	call   80104b90 <argstr>
...
801053c8:	e8 03 f7 ff ff       	call   80104ad0 <argint>
...
80105417:	74 23                	je     8010543c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105419:	e8 82 e5 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054f4:	e8 97 f6 ff ff       	call   80104b90 <argstr>
...
80105554:	e8 37 f6 ff ff       	call   80104b90 <argstr>
...
80105569:	e8 62 f5 ff ff       	call   80104ad0 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010557e:	e8 4d f5 ff ff       	call   80104ad0 <argint>
     argint(1, &major) < 0 ||
...
801055d5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055d8:	e8 c3 e3 ff ff       	call   801039a0 <myproc>
...
801055ed:	e8 9e f5 ff ff       	call   80104b90 <argstr>
...
80105695:	e8 f6 f4 ff ff       	call   80104b90 <argstr>
...
801056b1:	e8 1a f4 ff ff       	call   80104ad0 <argint>
...
801056d0:	e8 3b f1 ff ff       	call   80104810 <memset>
...
801056fa:	e8 41 f3 ff ff       	call   80104a40 <fetchint>
...
80105718:	e8 63 f3 ff ff       	call   80104a80 <fetchstr>
...
80105781:	e8 9a f3 ff ff       	call   80104b20 <argptr>
...
801057a7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801057a9:	e8 f2 e1 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057e7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801057ea:	e8 b1 e1 ff ff       	call   801039a0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105806:	75 f0                	jne    801057f8 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105808:	e8 93 e1 ff ff       	call   801039a0 <myproc>
...
{
  return fork();
80105840:	e9 fb e2 ff ff       	jmp    80103b40 <fork>
...
80105853:	83 ec 08             	sub    $0x8,%esp
  exit();
80105856:	e8 a5 e5 ff ff       	call   80103e00 <exit>
...
{
  return wait();
80105860:	e9 cb e6 ff ff       	jmp    80103f30 <wait>
...
8010587c:	e8 4f f2 ff ff       	call   80104ad0 <argint>
...
8010588e:	e8 3d e9 ff ff       	call   801041d0 <kill>
...
801058b3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801058b6:	e8 e5 e0 ff ff       	call   801039a0 <myproc>
...
801058d7:	78 27                	js     80105900 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801058d9:	e8 c2 e0 ff ff       	call   801039a0 <myproc>
  if(growproc(n) < 0)
...
801058e6:	e8 d5 e1 ff ff       	call   80103ac0 <growproc>
...
80105930:	68 80 50 11 80       	push   $0x80115080
80105935:	e8 16 ee ff ff       	call   80104750 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010593a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010593d:	8b 1d 60 50 11 80    	mov    0x80115060,%ebx
  while(ticks - ticks0 < n){
...
80105953:	68 80 50 11 80       	push   $0x80115080
80105958:	68 60 50 11 80       	push   $0x80115060
8010595d:	e8 4e e7 ff ff       	call   801040b0 <sleep>
  while(ticks - ticks0 < n){
80105962:	a1 60 50 11 80       	mov    0x80115060,%eax
...
8010596f:	73 2f                	jae    801059a0 <sys_sleep+0x90>
    if(myproc()->killed){
80105971:	e8 2a e0 ff ff       	call   801039a0 <myproc>
...
80105980:	68 80 50 11 80       	push   $0x80115080
80105985:	e8 66 ed ff ff       	call   801046f0 <release>
  }
  release(&tickslock);
  return 0;
}
...
801059a3:	68 80 50 11 80       	push   $0x80115080
801059a8:	e8 43 ed ff ff       	call   801046f0 <release>
  return 0;
...
801059c4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801059c7:	68 80 50 11 80       	push   $0x80115080
801059cc:	e8 7f ed ff ff       	call   80104750 <acquire>
  xticks = ticks;
801059d1:	8b 1d 60 50 11 80    	mov    0x80115060,%ebx
  release(&tickslock);
801059d7:	c7 04 24 80 50 11 80 	movl   $0x80115080,(%esp)
801059de:	e8 0d ed ff ff       	call   801046f0 <release>
  return xticks;
}
...
801059f3:	83 ec 14             	sub    $0x14,%esp
  cprintf("Hello\n");
801059f6:	68 69 7e 10 80       	push   $0x80107e69
801059fb:	e8 a0 ac ff ff       	call   801006a0 <cprintf>
  return 0;
}
...
80105a1c:	e8 6f f1 ff ff       	call   80104b90 <argstr>
  cprintf("%s",name);
80105a21:	58                   	pop    %eax
80105a22:	5a                   	pop    %edx
80105a23:	ff 75 f4             	push   -0xc(%ebp)
80105a26:	68 b5 7c 10 80       	push   $0x80107cb5
80105a2b:	e8 70 ac ff ff       	call   801006a0 <cprintf>
  return 0;
}
...
80105a6c:	e8 5f f0 ff ff       	call   80104ad0 <argint>
80105a71:	83 c4 10             	add    $0x10,%esp
80105a74:	85 c0                	test   %eax,%eax
80105a76:	78 28                	js     80105aa0 <sys_getProcInfo+0x40>
    return -1;
  }
...
80105a81:	e8 4a f0 ff ff       	call   80104ad0 <argint>
80105a86:	83 c4 10             	add    $0x10,%esp
80105a89:	85 c0                	test   %eax,%eax
80105a8b:	78 13                	js     80105aa0 <sys_getProcInfo+0x40>
    return -1;
  }
...
80105a96:	e8 15 e9 ff ff       	call   801043b0 <ProcInfo>
...
80105ac6:	78 18                	js     80105ae0 <sys_setprio+0x30>
    return -1;
  }
  myproc()->prio = i;
80105ac8:	e8 d3 de ff ff       	call   801039a0 <myproc>
80105acd:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105ad0:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  return 0;
...
80105af3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->prio;
80105af6:	e8 a5 de ff ff       	call   801039a0 <myproc>
80105afb:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
}
80105b01:	c9                   	leave  
80105b02:	c3                   	ret    
...
80105b1d:	e8 ae ef ff ff       	call   80104ad0 <argint>
80105b22:	83 c4 10             	add    $0x10,%esp
80105b25:	85 c0                	test   %eax,%eax
80105b27:	78 17                	js     80105b40 <sys_welcomeFunction+0x30>
    return -1;
  }
  char* xyz = (char*)ptr;
80105b29:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  myproc()->welcome_addr = xyz;
80105b2c:	e8 6f de ff ff       	call   801039a0 <myproc>
80105b31:	89 98 84 00 00 00    	mov    %ebx,0x84(%eax)
  return 0;
...
80105b45:	eb f2                	jmp    80105b39 <sys_welcomeFunction+0x29>
80105b47:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105b4e:	66 90                	xchg   %ax,%ax

80105b50 <sys_welcomeDone>:
...
80105b57:	e8 44 de ff ff       	call   801039a0 <myproc>
80105b5c:	8b 80 88 00 00 00    	mov    0x88(%eax),%eax
80105b62:	85 c0                	test   %eax,%eax
80105b64:	74 22                	je     80105b88 <sys_welcomeDone+0x38>
    myproc()->tf->eip = (uint)(myproc()->return_addr);
80105b66:	e8 35 de ff ff       	call   801039a0 <myproc>
80105b6b:	8b 98 88 00 00 00    	mov    0x88(%eax),%ebx
80105b71:	e8 2a de ff ff       	call   801039a0 <myproc>
80105b76:	8b 40 18             	mov    0x18(%eax),%eax
80105b79:	89 58 38             	mov    %ebx,0x38(%eax)
    return 0;
...
80105b8d:	eb ef                	jmp    80105b7e <sys_welcomeDone+0x2e>
80105b8f:	90                   	nop
...
80105b96:	e8 05 de ff ff       	call   801039a0 <myproc>
80105b9b:	8b 00                	mov    (%eax),%eax
}
80105b9d:	c9                   	leave  
  return PGROUNDUP(myproc()->sz)/PGSIZE;
80105b9e:	05 ff 0f 00 00       	add    $0xfff,%eax
80105ba3:	c1 e8 0c             	shr    $0xc,%eax
}
80105ba6:	c3                   	ret    
...
{
  return num_phy_page();
80105bb0:	e9 fb 19 00 00       	jmp    801075b0 <num_phy_page>
...
80105bce:	e8 fd ee ff ff       	call   80104ad0 <argint>
80105bd3:	83 c4 10             	add    $0x10,%esp
80105bd6:	85 c0                	test   %eax,%eax
80105bd8:	78 3a                	js     80105c14 <sys_mmap+0x54>
    return -1;
  }
...
80105bda:	8b 45 f4             	mov    -0xc(%ebp),%eax
    return 0;
80105bdd:	31 db                	xor    %ebx,%ebx
  if(size <= 0 || size % PGSIZE != 0){
80105bdf:	85 c0                	test   %eax,%eax
80105be1:	7e 07                	jle    80105bea <sys_mmap+0x2a>
80105be3:	a9 ff 0f 00 00       	test   $0xfff,%eax
80105be8:	74 0e                	je     80105bf8 <sys_mmap+0x38>
  int addr = myproc()->sz;
  int sz = addr + size;
  myproc()->sz = sz;

  return addr;
80105bea:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105bed:	89 d8                	mov    %ebx,%eax
80105bef:	5b                   	pop    %ebx
80105bf0:	5e                   	pop    %esi
80105bf1:	5d                   	pop    %ebp
80105bf2:	c3                   	ret    
...
80105bf8:	e8 a3 dd ff ff       	call   801039a0 <myproc>
  int sz = addr + size;
80105bfd:	8b 75 f4             	mov    -0xc(%ebp),%esi
  int addr = myproc()->sz;
80105c00:	8b 18                	mov    (%eax),%ebx
  myproc()->sz = sz;
80105c02:	e8 99 dd ff ff       	call   801039a0 <myproc>
  int sz = addr + size;
80105c07:	01 de                	add    %ebx,%esi
  myproc()->sz = sz;
80105c09:	89 30                	mov    %esi,(%eax)
80105c0b:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
80105c13:	c3                   	ret    
    return -1;
80105c14:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105c19:	eb cf                	jmp    80105bea <sys_mmap+0x2a>
...
80105c1c:	06                   	push   %es
  pushl %fs
80105c1d:	0f a0                	push   %fs
  pushl %gs
80105c1f:	0f a8                	push   %gs
  pushal
80105c21:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105c22:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105c26:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105c28:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105c2a:	54                   	push   %esp
  call trap
80105c2b:	e8 c0 00 00 00       	call   80105cf0 <trap>
  addl $4, %esp
80105c30:	83 c4 04             	add    $0x4,%esp
...
80105c33:	61                   	popa   
  popl %gs
80105c34:	0f a9                	pop    %gs
  popl %fs
80105c36:	0f a1                	pop    %fs
  popl %es
80105c38:	07                   	pop    %es
  popl %ds
80105c39:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105c3a:	83 c4 08             	add    $0x8,%esp
  iret
80105c3d:	cf                   	iret   
...
80105c50:	8b 14 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%edx
80105c57:	c7 04 c5 c2 50 11 80 	movl   $0x8e000008,-0x7feeaf3e(,%eax,8)
80105c5e:	08 00 00 8e 
80105c62:	66 89 14 c5 c0 50 11 	mov    %dx,-0x7feeaf40(,%eax,8)
80105c69:	80 
80105c6a:	c1 ea 10             	shr    $0x10,%edx
80105c6d:	66 89 14 c5 c6 50 11 	mov    %dx,-0x7feeaf3a(,%eax,8)
80105c74:	80 
  for(i = 0; i < 256; i++)
...
80105c7f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c82:	a1 0c b1 10 80       	mov    0x8010b10c,%eax
80105c87:	c7 05 c2 52 11 80 08 	movl   $0xef000008,0x801152c2
80105c8e:	00 00 ef 
  initlock(&tickslock, "time");
80105c91:	68 70 7e 10 80       	push   $0x80107e70
80105c96:	68 80 50 11 80       	push   $0x80115080
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c9b:	66 a3 c0 52 11 80    	mov    %ax,0x801152c0
80105ca1:	c1 e8 10             	shr    $0x10,%eax
80105ca4:	66 a3 c6 52 11 80    	mov    %ax,0x801152c6
  initlock(&tickslock, "time");
80105caa:	e8 d1 e8 ff ff       	call   80104580 <initlock>
}
...
80105ccb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105ccf:	b8 c0 50 11 80       	mov    $0x801150c0,%eax
...
80105d14:	ff 24 85 18 7f 10 80 	jmp    *-0x7fef80e8(,%eax,4)
80105d1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105d1f:	90                   	nop
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105d20:	e8 5b dc ff ff       	call   80103980 <cpuid>
80105d25:	85 c0                	test   %eax,%eax
80105d27:	0f 84 43 02 00 00    	je     80105f70 <trap+0x280>
    }
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE:
...
80105d6a:	0f 84 b8 00 00 00    	je     80105e28 <trap+0x138>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d70:	e8 2b dc ff ff       	call   801039a0 <myproc>
...
80105d85:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
...
80105da7:	0f 84 f7 01 00 00    	je     80105fa4 <trap+0x2b4>
80105dad:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105db1:	0f 84 ed 01 00 00    	je     80105fa4 <trap+0x2b4>
...
80105dba:	8b 53 38             	mov    0x38(%ebx),%edx
80105dbd:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105dc0:	89 55 dc             	mov    %edx,-0x24(%ebp)
80105dc3:	e8 b8 db ff ff       	call   80103980 <cpuid>
80105dc8:	8b 73 30             	mov    0x30(%ebx),%esi
80105dcb:	89 c7                	mov    %eax,%edi
80105dcd:	8b 43 34             	mov    0x34(%ebx),%eax
80105dd0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            myproc()->pid, myproc()->name, tf->trapno,
80105dd3:	e8 c8 db ff ff       	call   801039a0 <myproc>
80105dd8:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105ddb:	e8 c0 db ff ff       	call   801039a0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105dec:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105ded:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105df0:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105df3:	56                   	push   %esi
80105df4:	ff 70 10             	push   0x10(%eax)
80105df7:	68 d4 7e 10 80       	push   $0x80107ed4
80105dfc:	e8 9f a8 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105e01:	83 c4 20             	add    $0x20,%esp
80105e04:	e8 97 db ff ff       	call   801039a0 <myproc>
...
80105e22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105e28:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105e2c:	0f 85 3e ff ff ff    	jne    80105d70 <trap+0x80>
    yield();
80105e32:	e8 29 e2 ff ff       	call   80104060 <yield>
80105e37:	e9 34 ff ff ff       	jmp    80105d70 <trap+0x80>
80105e3c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105e40:	e8 5b db ff ff       	call   801039a0 <myproc>
80105e45:	8b 70 24             	mov    0x24(%eax),%esi
80105e48:	85 f6                	test   %esi,%esi
80105e4a:	0f 85 00 01 00 00    	jne    80105f50 <trap+0x260>
    myproc()->tf = tf;
80105e50:	e8 4b db ff ff       	call   801039a0 <myproc>
80105e55:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e58:	e8 b3 ed ff ff       	call   80104c10 <syscall>
    if(myproc()->killed)
80105e5d:	e8 3e db ff ff       	call   801039a0 <myproc>
...
80105e73:	5d                   	pop    %ebp
      exit();
80105e74:	e9 87 df ff ff       	jmp    80103e00 <exit>
80105e79:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105e80:	8b 7b 38             	mov    0x38(%ebx),%edi
80105e83:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105e87:	e8 f4 da ff ff       	call   80103980 <cpuid>
80105e8c:	57                   	push   %edi
80105e8d:	56                   	push   %esi
80105e8e:	50                   	push   %eax
80105e8f:	68 7c 7e 10 80       	push   $0x80107e7c
...
80105ebd:	e8 4e ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ec2:	e8 d9 da ff ff       	call   801039a0 <myproc>
...
80105ed4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105ed8:	e8 63 02 00 00       	call   80106140 <uartintr>
    lapiceoi();
80105edd:	e8 2e ca ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ee2:	e8 b9 da ff ff       	call   801039a0 <myproc>
...
80105f08:	0f 20 d6             	mov    %cr2,%esi
    uint pg_addr = PGROUNDDOWN(addr);
80105f0b:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if(pg_addr > myproc()->sz || pg_addr < 0){
80105f11:	e8 8a da ff ff       	call   801039a0 <myproc>
80105f16:	39 30                	cmp    %esi,(%eax)
80105f18:	72 46                	jb     80105f60 <trap+0x270>
    allocate_on_pgflt(pg_addr);
80105f1a:	83 ec 0c             	sub    $0xc,%esp
80105f1d:	56                   	push   %esi
80105f1e:	e8 fd 16 00 00       	call   80107620 <allocate_on_pgflt>
    break;
80105f23:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105f26:	e8 75 da ff ff       	call   801039a0 <myproc>
80105f2b:	85 c0                	test   %eax,%eax
80105f2d:	0f 85 08 fe ff ff    	jne    80105d3b <trap+0x4b>
80105f33:	e9 20 fe ff ff       	jmp    80105d58 <trap+0x68>
80105f38:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105f3f:	90                   	nop
    exit();
80105f40:	e8 bb de ff ff       	call   80103e00 <exit>
80105f45:	e9 0e fe ff ff       	jmp    80105d58 <trap+0x68>
80105f4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105f50:	e8 ab de ff ff       	call   80103e00 <exit>
80105f55:	e9 f6 fe ff ff       	jmp    80105e50 <trap+0x160>
80105f5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105f60:	e8 9b de ff ff       	call   80103e00 <exit>
80105f65:	eb b3                	jmp    80105f1a <trap+0x22a>
80105f67:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105f6e:	66 90                	xchg   %ax,%ax
      acquire(&tickslock);
80105f70:	83 ec 0c             	sub    $0xc,%esp
80105f73:	68 80 50 11 80       	push   $0x80115080
80105f78:	e8 d3 e7 ff ff       	call   80104750 <acquire>
      wakeup(&ticks);
80105f7d:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
      ticks++;
80105f84:	83 05 60 50 11 80 01 	addl   $0x1,0x80115060
      wakeup(&ticks);
80105f8b:	e8 e0 e1 ff ff       	call   80104170 <wakeup>
      release(&tickslock);
80105f90:	c7 04 24 80 50 11 80 	movl   $0x80115080,(%esp)
80105f97:	e8 54 e7 ff ff       	call   801046f0 <release>
80105f9c:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105f9f:	e9 89 fd ff ff       	jmp    80105d2d <trap+0x3d>
80105fa4:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105fa7:	8b 73 38             	mov    0x38(%ebx),%esi
80105faa:	e8 d1 d9 ff ff       	call   80103980 <cpuid>
80105faf:	83 ec 0c             	sub    $0xc,%esp
80105fb2:	57                   	push   %edi
80105fb3:	56                   	push   %esi
80105fb4:	50                   	push   %eax
80105fb5:	ff 73 30             	push   0x30(%ebx)
80105fb8:	68 a0 7e 10 80       	push   $0x80107ea0
80105fbd:	e8 de a6 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105fc2:	83 c4 14             	add    $0x14,%esp
80105fc5:	68 75 7e 10 80       	push   $0x80107e75
80105fca:	e8 b1 a3 ff ff       	call   80100380 <panic>
80105fcf:	90                   	nop
...
{
  if(!uart)
80105fd0:	a1 c0 58 11 80       	mov    0x801158c0,%eax
...
80106057:	74 78                	je     801060d1 <uartinit+0xd1>
  uart = 1;
80106059:	c7 05 c0 58 11 80 01 	movl   $0x1,0x801158c0
80106060:	00 00 00 
...
8010606c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
8010606f:	bf e0 7f 10 80       	mov    $0x80107fe0,%edi
...
801060e0 <uartputc>:
  if(!uart)
801060e0:	a1 c0 58 11 80       	mov    0x801158c0,%eax
...
80106157:	6a 00                	push   $0x0
  jmp alltraps
80106159:	e9 bd fa ff ff       	jmp    80105c1b <alltraps>
...
80106160:	6a 01                	push   $0x1
  jmp alltraps
80106162:	e9 b4 fa ff ff       	jmp    80105c1b <alltraps>
...
80106169:	6a 02                	push   $0x2
  jmp alltraps
8010616b:	e9 ab fa ff ff       	jmp    80105c1b <alltraps>
...
80106172:	6a 03                	push   $0x3
  jmp alltraps
80106174:	e9 a2 fa ff ff       	jmp    80105c1b <alltraps>
...
8010617b:	6a 04                	push   $0x4
  jmp alltraps
8010617d:	e9 99 fa ff ff       	jmp    80105c1b <alltraps>
...
80106184:	6a 05                	push   $0x5
  jmp alltraps
80106186:	e9 90 fa ff ff       	jmp    80105c1b <alltraps>
...
8010618d:	6a 06                	push   $0x6
  jmp alltraps
8010618f:	e9 87 fa ff ff       	jmp    80105c1b <alltraps>
...
80106196:	6a 07                	push   $0x7
  jmp alltraps
80106198:	e9 7e fa ff ff       	jmp    80105c1b <alltraps>
...
8010619d:	6a 08                	push   $0x8
  jmp alltraps
8010619f:	e9 77 fa ff ff       	jmp    80105c1b <alltraps>
...
801061a6:	6a 09                	push   $0x9
  jmp alltraps
801061a8:	e9 6e fa ff ff       	jmp    80105c1b <alltraps>
...
801061ad:	6a 0a                	push   $0xa
  jmp alltraps
801061af:	e9 67 fa ff ff       	jmp    80105c1b <alltraps>
...
801061b4:	6a 0b                	push   $0xb
  jmp alltraps
801061b6:	e9 60 fa ff ff       	jmp    80105c1b <alltraps>
...
801061bb:	6a 0c                	push   $0xc
  jmp alltraps
801061bd:	e9 59 fa ff ff       	jmp    80105c1b <alltraps>
...
801061c2:	6a 0d                	push   $0xd
  jmp alltraps
801061c4:	e9 52 fa ff ff       	jmp    80105c1b <alltraps>
...
801061c9:	6a 0e                	push   $0xe
  jmp alltraps
801061cb:	e9 4b fa ff ff       	jmp    80105c1b <alltraps>
...
801061d2:	6a 0f                	push   $0xf
  jmp alltraps
801061d4:	e9 42 fa ff ff       	jmp    80105c1b <alltraps>
...
801061db:	6a 10                	push   $0x10
  jmp alltraps
801061dd:	e9 39 fa ff ff       	jmp    80105c1b <alltraps>
...
801061e2:	6a 11                	push   $0x11
  jmp alltraps
801061e4:	e9 32 fa ff ff       	jmp    80105c1b <alltraps>
...
801061eb:	6a 12                	push   $0x12
  jmp alltraps
801061ed:	e9 29 fa ff ff       	jmp    80105c1b <alltraps>
...
801061f4:	6a 13                	push   $0x13
  jmp alltraps
801061f6:	e9 20 fa ff ff       	jmp    80105c1b <alltraps>
...
801061fd:	6a 14                	push   $0x14
  jmp alltraps
801061ff:	e9 17 fa ff ff       	jmp    80105c1b <alltraps>
...
80106206:	6a 15                	push   $0x15
  jmp alltraps
80106208:	e9 0e fa ff ff       	jmp    80105c1b <alltraps>
...
8010620f:	6a 16                	push   $0x16
  jmp alltraps
80106211:	e9 05 fa ff ff       	jmp    80105c1b <alltraps>
...
80106218:	6a 17                	push   $0x17
  jmp alltraps
8010621a:	e9 fc f9 ff ff       	jmp    80105c1b <alltraps>
...
80106221:	6a 18                	push   $0x18
  jmp alltraps
80106223:	e9 f3 f9 ff ff       	jmp    80105c1b <alltraps>
...
8010622a:	6a 19                	push   $0x19
  jmp alltraps
8010622c:	e9 ea f9 ff ff       	jmp    80105c1b <alltraps>
...
80106233:	6a 1a                	push   $0x1a
  jmp alltraps
80106235:	e9 e1 f9 ff ff       	jmp    80105c1b <alltraps>
...
8010623c:	6a 1b                	push   $0x1b
  jmp alltraps
8010623e:	e9 d8 f9 ff ff       	jmp    80105c1b <alltraps>
...
80106245:	6a 1c                	push   $0x1c
  jmp alltraps
80106247:	e9 cf f9 ff ff       	jmp    80105c1b <alltraps>
...
8010624e:	6a 1d                	push   $0x1d
  jmp alltraps
80106250:	e9 c6 f9 ff ff       	jmp    80105c1b <alltraps>
...
80106257:	6a 1e                	push   $0x1e
  jmp alltraps
80106259:	e9 bd f9 ff ff       	jmp    80105c1b <alltraps>
...
80106260:	6a 1f                	push   $0x1f
  jmp alltraps
80106262:	e9 b4 f9 ff ff       	jmp    80105c1b <alltraps>
...
80106269:	6a 20                	push   $0x20
  jmp alltraps
8010626b:	e9 ab f9 ff ff       	jmp    80105c1b <alltraps>
...
80106272:	6a 21                	push   $0x21
  jmp alltraps
80106274:	e9 a2 f9 ff ff       	jmp    80105c1b <alltraps>
...
8010627b:	6a 22                	push   $0x22
  jmp alltraps
8010627d:	e9 99 f9 ff ff       	jmp    80105c1b <alltraps>
...
80106284:	6a 23                	push   $0x23
  jmp alltraps
80106286:	e9 90 f9 ff ff       	jmp    80105c1b <alltraps>
...
8010628d:	6a 24                	push   $0x24
  jmp alltraps
8010628f:	e9 87 f9 ff ff       	jmp    80105c1b <alltraps>
...
80106296:	6a 25                	push   $0x25
  jmp alltraps
80106298:	e9 7e f9 ff ff       	jmp    80105c1b <alltraps>
...
8010629f:	6a 26                	push   $0x26
  jmp alltraps
801062a1:	e9 75 f9 ff ff       	jmp    80105c1b <alltraps>
...
801062a8:	6a 27                	push   $0x27
  jmp alltraps
801062aa:	e9 6c f9 ff ff       	jmp    80105c1b <alltraps>
...
801062b1:	6a 28                	push   $0x28
  jmp alltraps
801062b3:	e9 63 f9 ff ff       	jmp    80105c1b <alltraps>
...
801062ba:	6a 29                	push   $0x29
  jmp alltraps
801062bc:	e9 5a f9 ff ff       	jmp    80105c1b <alltraps>
...
801062c3:	6a 2a                	push   $0x2a
  jmp alltraps
801062c5:	e9 51 f9 ff ff       	jmp    80105c1b <alltraps>
...
801062cc:	6a 2b                	push   $0x2b
  jmp alltraps
801062ce:	e9 48 f9 ff ff       	jmp    80105c1b <alltraps>
...
801062d5:	6a 2c                	push   $0x2c
  jmp alltraps
801062d7:	e9 3f f9 ff ff       	jmp    80105c1b <alltraps>
...
801062de:	6a 2d                	push   $0x2d
  jmp alltraps
801062e0:	e9 36 f9 ff ff       	jmp    80105c1b <alltraps>
...
801062e7:	6a 2e                	push   $0x2e
  jmp alltraps
801062e9:	e9 2d f9 ff ff       	jmp    80105c1b <alltraps>
...
801062f0:	6a 2f                	push   $0x2f
  jmp alltraps
801062f2:	e9 24 f9 ff ff       	jmp    80105c1b <alltraps>
...
801062f9:	6a 30                	push   $0x30
  jmp alltraps
801062fb:	e9 1b f9 ff ff       	jmp    80105c1b <alltraps>
...
80106302:	6a 31                	push   $0x31
  jmp alltraps
80106304:	e9 12 f9 ff ff       	jmp    80105c1b <alltraps>
...
8010630b:	6a 32                	push   $0x32
  jmp alltraps
8010630d:	e9 09 f9 ff ff       	jmp    80105c1b <alltraps>
...
80106314:	6a 33                	push   $0x33
  jmp alltraps
80106316:	e9 00 f9 ff ff       	jmp    80105c1b <alltraps>
...
8010631d:	6a 34                	push   $0x34
  jmp alltraps
8010631f:	e9 f7 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106326:	6a 35                	push   $0x35
  jmp alltraps
80106328:	e9 ee f8 ff ff       	jmp    80105c1b <alltraps>
...
8010632f:	6a 36                	push   $0x36
  jmp alltraps
80106331:	e9 e5 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106338:	6a 37                	push   $0x37
  jmp alltraps
8010633a:	e9 dc f8 ff ff       	jmp    80105c1b <alltraps>
...
80106341:	6a 38                	push   $0x38
  jmp alltraps
80106343:	e9 d3 f8 ff ff       	jmp    80105c1b <alltraps>
...
8010634a:	6a 39                	push   $0x39
  jmp alltraps
8010634c:	e9 ca f8 ff ff       	jmp    80105c1b <alltraps>
...
80106353:	6a 3a                	push   $0x3a
  jmp alltraps
80106355:	e9 c1 f8 ff ff       	jmp    80105c1b <alltraps>
...
8010635c:	6a 3b                	push   $0x3b
  jmp alltraps
8010635e:	e9 b8 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106365:	6a 3c                	push   $0x3c
  jmp alltraps
80106367:	e9 af f8 ff ff       	jmp    80105c1b <alltraps>
...
8010636e:	6a 3d                	push   $0x3d
  jmp alltraps
80106370:	e9 a6 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106377:	6a 3e                	push   $0x3e
  jmp alltraps
80106379:	e9 9d f8 ff ff       	jmp    80105c1b <alltraps>
...
80106380:	6a 3f                	push   $0x3f
  jmp alltraps
80106382:	e9 94 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106389:	6a 40                	push   $0x40
  jmp alltraps
8010638b:	e9 8b f8 ff ff       	jmp    80105c1b <alltraps>
...
80106392:	6a 41                	push   $0x41
  jmp alltraps
80106394:	e9 82 f8 ff ff       	jmp    80105c1b <alltraps>
...
8010639b:	6a 42                	push   $0x42
  jmp alltraps
8010639d:	e9 79 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063a4:	6a 43                	push   $0x43
  jmp alltraps
801063a6:	e9 70 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063ad:	6a 44                	push   $0x44
  jmp alltraps
801063af:	e9 67 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063b6:	6a 45                	push   $0x45
  jmp alltraps
801063b8:	e9 5e f8 ff ff       	jmp    80105c1b <alltraps>
...
801063bf:	6a 46                	push   $0x46
  jmp alltraps
801063c1:	e9 55 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063c8:	6a 47                	push   $0x47
  jmp alltraps
801063ca:	e9 4c f8 ff ff       	jmp    80105c1b <alltraps>
...
801063d1:	6a 48                	push   $0x48
  jmp alltraps
801063d3:	e9 43 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063da:	6a 49                	push   $0x49
  jmp alltraps
801063dc:	e9 3a f8 ff ff       	jmp    80105c1b <alltraps>
...
801063e3:	6a 4a                	push   $0x4a
  jmp alltraps
801063e5:	e9 31 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063ec:	6a 4b                	push   $0x4b
  jmp alltraps
801063ee:	e9 28 f8 ff ff       	jmp    80105c1b <alltraps>
...
801063f5:	6a 4c                	push   $0x4c
  jmp alltraps
801063f7:	e9 1f f8 ff ff       	jmp    80105c1b <alltraps>
...
801063fe:	6a 4d                	push   $0x4d
  jmp alltraps
80106400:	e9 16 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106407:	6a 4e                	push   $0x4e
  jmp alltraps
80106409:	e9 0d f8 ff ff       	jmp    80105c1b <alltraps>
...
80106410:	6a 4f                	push   $0x4f
  jmp alltraps
80106412:	e9 04 f8 ff ff       	jmp    80105c1b <alltraps>
...
80106419:	6a 50                	push   $0x50
  jmp alltraps
8010641b:	e9 fb f7 ff ff       	jmp    80105c1b <alltraps>
...
80106422:	6a 51                	push   $0x51
  jmp alltraps
80106424:	e9 f2 f7 ff ff       	jmp    80105c1b <alltraps>
...
8010642b:	6a 52                	push   $0x52
  jmp alltraps
8010642d:	e9 e9 f7 ff ff       	jmp    80105c1b <alltraps>
...
80106434:	6a 53                	push   $0x53
  jmp alltraps
80106436:	e9 e0 f7 ff ff       	jmp    80105c1b <alltraps>
...
8010643d:	6a 54                	push   $0x54
  jmp alltraps
8010643f:	e9 d7 f7 ff ff       	jmp    80105c1b <alltraps>
...
80106446:	6a 55                	push   $0x55
  jmp alltraps
80106448:	e9 ce f7 ff ff       	jmp    80105c1b <alltraps>
...
8010644f:	6a 56                	push   $0x56
  jmp alltraps
80106451:	e9 c5 f7 ff ff       	jmp    80105c1b <alltraps>
...
80106458:	6a 57                	push   $0x57
  jmp alltraps
8010645a:	e9 bc f7 ff ff       	jmp    80105c1b <alltraps>
...
80106461:	6a 58                	push   $0x58
  jmp alltraps
80106463:	e9 b3 f7 ff ff       	jmp    80105c1b <alltraps>
...
8010646a:	6a 59                	push   $0x59
  jmp alltraps
8010646c:	e9 aa f7 ff ff       	jmp    80105c1b <alltraps>
...
80106473:	6a 5a                	push   $0x5a
  jmp alltraps
80106475:	e9 a1 f7 ff ff       	jmp    80105c1b <alltraps>
...
8010647c:	6a 5b                	push   $0x5b
  jmp alltraps
8010647e:	e9 98 f7 ff ff       	jmp    80105c1b <alltraps>
...
80106485:	6a 5c                	push   $0x5c
  jmp alltraps
80106487:	e9 8f f7 ff ff       	jmp    80105c1b <alltraps>
...
8010648e:	6a 5d                	push   $0x5d
  jmp alltraps
80106490:	e9 86 f7 ff ff       	jmp    80105c1b <alltraps>
...
80106497:	6a 5e                	push   $0x5e
  jmp alltraps
80106499:	e9 7d f7 ff ff       	jmp    80105c1b <alltraps>
...
801064a0:	6a 5f                	push   $0x5f
  jmp alltraps
801064a2:	e9 74 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064a9:	6a 60                	push   $0x60
  jmp alltraps
801064ab:	e9 6b f7 ff ff       	jmp    80105c1b <alltraps>
...
801064b2:	6a 61                	push   $0x61
  jmp alltraps
801064b4:	e9 62 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064bb:	6a 62                	push   $0x62
  jmp alltraps
801064bd:	e9 59 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064c4:	6a 63                	push   $0x63
  jmp alltraps
801064c6:	e9 50 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064cd:	6a 64                	push   $0x64
  jmp alltraps
801064cf:	e9 47 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064d6:	6a 65                	push   $0x65
  jmp alltraps
801064d8:	e9 3e f7 ff ff       	jmp    80105c1b <alltraps>
...
801064df:	6a 66                	push   $0x66
  jmp alltraps
801064e1:	e9 35 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064e8:	6a 67                	push   $0x67
  jmp alltraps
801064ea:	e9 2c f7 ff ff       	jmp    80105c1b <alltraps>
...
801064f1:	6a 68                	push   $0x68
  jmp alltraps
801064f3:	e9 23 f7 ff ff       	jmp    80105c1b <alltraps>
...
801064fa:	6a 69                	push   $0x69
  jmp alltraps
801064fc:	e9 1a f7 ff ff       	jmp    80105c1b <alltraps>
...
80106503:	6a 6a                	push   $0x6a
  jmp alltraps
80106505:	e9 11 f7 ff ff       	jmp    80105c1b <alltraps>
...
8010650c:	6a 6b                	push   $0x6b
  jmp alltraps
8010650e:	e9 08 f7 ff ff       	jmp    80105c1b <alltraps>
...
80106515:	6a 6c                	push   $0x6c
  jmp alltraps
80106517:	e9 ff f6 ff ff       	jmp    80105c1b <alltraps>
...
8010651e:	6a 6d                	push   $0x6d
  jmp alltraps
80106520:	e9 f6 f6 ff ff       	jmp    80105c1b <alltraps>
...
80106527:	6a 6e                	push   $0x6e
  jmp alltraps
80106529:	e9 ed f6 ff ff       	jmp    80105c1b <alltraps>
...
80106530:	6a 6f                	push   $0x6f
  jmp alltraps
80106532:	e9 e4 f6 ff ff       	jmp    80105c1b <alltraps>
...
80106539:	6a 70                	push   $0x70
  jmp alltraps
8010653b:	e9 db f6 ff ff       	jmp    80105c1b <alltraps>
...
80106542:	6a 71                	push   $0x71
  jmp alltraps
80106544:	e9 d2 f6 ff ff       	jmp    80105c1b <alltraps>
...
8010654b:	6a 72                	push   $0x72
  jmp alltraps
8010654d:	e9 c9 f6 ff ff       	jmp    80105c1b <alltraps>
...
80106554:	6a 73                	push   $0x73
  jmp alltraps
80106556:	e9 c0 f6 ff ff       	jmp    80105c1b <alltraps>
...
8010655d:	6a 74                	push   $0x74
  jmp alltraps
8010655f:	e9 b7 f6 ff ff       	jmp    80105c1b <alltraps>
...
80106566:	6a 75                	push   $0x75
  jmp alltraps
80106568:	e9 ae f6 ff ff       	jmp    80105c1b <alltraps>
...
8010656f:	6a 76                	push   $0x76
  jmp alltraps
80106571:	e9 a5 f6 ff ff       	jmp    80105c1b <alltraps>
...
80106578:	6a 77                	push   $0x77
  jmp alltraps
8010657a:	e9 9c f6 ff ff       	jmp    80105c1b <alltraps>
...
80106581:	6a 78                	push   $0x78
  jmp alltraps
80106583:	e9 93 f6 ff ff       	jmp    80105c1b <alltraps>
...
8010658a:	6a 79                	push   $0x79
  jmp alltraps
8010658c:	e9 8a f6 ff ff       	jmp    80105c1b <alltraps>
...
80106593:	6a 7a                	push   $0x7a
  jmp alltraps
80106595:	e9 81 f6 ff ff       	jmp    80105c1b <alltraps>
...
8010659c:	6a 7b                	push   $0x7b
  jmp alltraps
8010659e:	e9 78 f6 ff ff       	jmp    80105c1b <alltraps>
...
801065a5:	6a 7c                	push   $0x7c
  jmp alltraps
801065a7:	e9 6f f6 ff ff       	jmp    80105c1b <alltraps>
...
801065ae:	6a 7d                	push   $0x7d
  jmp alltraps
801065b0:	e9 66 f6 ff ff       	jmp    80105c1b <alltraps>
...
801065b7:	6a 7e                	push   $0x7e
  jmp alltraps
801065b9:	e9 5d f6 ff ff       	jmp    80105c1b <alltraps>
...
801065c0:	6a 7f                	push   $0x7f
  jmp alltraps
801065c2:	e9 54 f6 ff ff       	jmp    80105c1b <alltraps>
...
801065c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801065ce:	e9 48 f6 ff ff       	jmp    80105c1b <alltraps>
...
801065d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801065da:	e9 3c f6 ff ff       	jmp    80105c1b <alltraps>
...
801065e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801065e6:	e9 30 f6 ff ff       	jmp    80105c1b <alltraps>
...
801065ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801065f2:	e9 24 f6 ff ff       	jmp    80105c1b <alltraps>
...
801065f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801065fe:	e9 18 f6 ff ff       	jmp    80105c1b <alltraps>
...
80106605:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010660a:	e9 0c f6 ff ff       	jmp    80105c1b <alltraps>
...
80106611:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106616:	e9 00 f6 ff ff       	jmp    80105c1b <alltraps>
...
8010661d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106622:	e9 f4 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106629:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010662e:	e9 e8 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106635:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010663a:	e9 dc f5 ff ff       	jmp    80105c1b <alltraps>
...
80106641:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106646:	e9 d0 f5 ff ff       	jmp    80105c1b <alltraps>
...
8010664d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106652:	e9 c4 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106659:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010665e:	e9 b8 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106665:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010666a:	e9 ac f5 ff ff       	jmp    80105c1b <alltraps>
...
80106671:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106676:	e9 a0 f5 ff ff       	jmp    80105c1b <alltraps>
...
8010667d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106682:	e9 94 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106689:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010668e:	e9 88 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106695:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010669a:	e9 7c f5 ff ff       	jmp    80105c1b <alltraps>
...
801066a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801066a6:	e9 70 f5 ff ff       	jmp    80105c1b <alltraps>
...
801066ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801066b2:	e9 64 f5 ff ff       	jmp    80105c1b <alltraps>
...
801066b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801066be:	e9 58 f5 ff ff       	jmp    80105c1b <alltraps>
...
801066c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801066ca:	e9 4c f5 ff ff       	jmp    80105c1b <alltraps>
...
801066d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801066d6:	e9 40 f5 ff ff       	jmp    80105c1b <alltraps>
...
801066dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801066e2:	e9 34 f5 ff ff       	jmp    80105c1b <alltraps>
...
801066e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801066ee:	e9 28 f5 ff ff       	jmp    80105c1b <alltraps>
...
801066f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801066fa:	e9 1c f5 ff ff       	jmp    80105c1b <alltraps>
...
80106701:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106706:	e9 10 f5 ff ff       	jmp    80105c1b <alltraps>
...
8010670d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106712:	e9 04 f5 ff ff       	jmp    80105c1b <alltraps>
...
80106719:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010671e:	e9 f8 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106725:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010672a:	e9 ec f4 ff ff       	jmp    80105c1b <alltraps>
...
80106731:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106736:	e9 e0 f4 ff ff       	jmp    80105c1b <alltraps>
...
8010673d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106742:	e9 d4 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106749:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010674e:	e9 c8 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106755:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010675a:	e9 bc f4 ff ff       	jmp    80105c1b <alltraps>
...
80106761:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106766:	e9 b0 f4 ff ff       	jmp    80105c1b <alltraps>
...
8010676d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106772:	e9 a4 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106779:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010677e:	e9 98 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106785:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010678a:	e9 8c f4 ff ff       	jmp    80105c1b <alltraps>
...
80106791:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106796:	e9 80 f4 ff ff       	jmp    80105c1b <alltraps>
...
8010679d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801067a2:	e9 74 f4 ff ff       	jmp    80105c1b <alltraps>
...
801067a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801067ae:	e9 68 f4 ff ff       	jmp    80105c1b <alltraps>
...
801067b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801067ba:	e9 5c f4 ff ff       	jmp    80105c1b <alltraps>
...
801067c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801067c6:	e9 50 f4 ff ff       	jmp    80105c1b <alltraps>
...
801067cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801067d2:	e9 44 f4 ff ff       	jmp    80105c1b <alltraps>
...
801067d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801067de:	e9 38 f4 ff ff       	jmp    80105c1b <alltraps>
...
801067e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801067ea:	e9 2c f4 ff ff       	jmp    80105c1b <alltraps>
...
801067f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801067f6:	e9 20 f4 ff ff       	jmp    80105c1b <alltraps>
...
801067fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106802:	e9 14 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106809:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010680e:	e9 08 f4 ff ff       	jmp    80105c1b <alltraps>
...
80106815:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010681a:	e9 fc f3 ff ff       	jmp    80105c1b <alltraps>
...
80106821:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106826:	e9 f0 f3 ff ff       	jmp    80105c1b <alltraps>
...
8010682d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106832:	e9 e4 f3 ff ff       	jmp    80105c1b <alltraps>
...
80106839:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010683e:	e9 d8 f3 ff ff       	jmp    80105c1b <alltraps>
...
80106845:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010684a:	e9 cc f3 ff ff       	jmp    80105c1b <alltraps>
...
80106851:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106856:	e9 c0 f3 ff ff       	jmp    80105c1b <alltraps>
...
8010685d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106862:	e9 b4 f3 ff ff       	jmp    80105c1b <alltraps>
...
80106869:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010686e:	e9 a8 f3 ff ff       	jmp    80105c1b <alltraps>
...
80106875:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010687a:	e9 9c f3 ff ff       	jmp    80105c1b <alltraps>
...
80106881:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106886:	e9 90 f3 ff ff       	jmp    80105c1b <alltraps>
...
8010688d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106892:	e9 84 f3 ff ff       	jmp    80105c1b <alltraps>
...
80106899:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010689e:	e9 78 f3 ff ff       	jmp    80105c1b <alltraps>
...
801068a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801068aa:	e9 6c f3 ff ff       	jmp    80105c1b <alltraps>
...
801068b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801068b6:	e9 60 f3 ff ff       	jmp    80105c1b <alltraps>
...
801068bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801068c2:	e9 54 f3 ff ff       	jmp    80105c1b <alltraps>
...
801068c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801068ce:	e9 48 f3 ff ff       	jmp    80105c1b <alltraps>
...
801068d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801068da:	e9 3c f3 ff ff       	jmp    80105c1b <alltraps>
...
801068e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801068e6:	e9 30 f3 ff ff       	jmp    80105c1b <alltraps>
...
801068ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801068f2:	e9 24 f3 ff ff       	jmp    80105c1b <alltraps>
...
801068f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801068fe:	e9 18 f3 ff ff       	jmp    80105c1b <alltraps>
...
80106905:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010690a:	e9 0c f3 ff ff       	jmp    80105c1b <alltraps>
...
80106911:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106916:	e9 00 f3 ff ff       	jmp    80105c1b <alltraps>
...
8010691d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106922:	e9 f4 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106929:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010692e:	e9 e8 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106935:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010693a:	e9 dc f2 ff ff       	jmp    80105c1b <alltraps>
...
80106941:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106946:	e9 d0 f2 ff ff       	jmp    80105c1b <alltraps>
...
8010694d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106952:	e9 c4 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106959:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010695e:	e9 b8 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106965:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010696a:	e9 ac f2 ff ff       	jmp    80105c1b <alltraps>
...
80106971:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106976:	e9 a0 f2 ff ff       	jmp    80105c1b <alltraps>
...
8010697d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106982:	e9 94 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106989:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010698e:	e9 88 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106995:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010699a:	e9 7c f2 ff ff       	jmp    80105c1b <alltraps>
...
801069a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801069a6:	e9 70 f2 ff ff       	jmp    80105c1b <alltraps>
...
801069ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801069b2:	e9 64 f2 ff ff       	jmp    80105c1b <alltraps>
...
801069b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801069be:	e9 58 f2 ff ff       	jmp    80105c1b <alltraps>
...
801069c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801069ca:	e9 4c f2 ff ff       	jmp    80105c1b <alltraps>
...
801069d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801069d6:	e9 40 f2 ff ff       	jmp    80105c1b <alltraps>
...
801069dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801069e2:	e9 34 f2 ff ff       	jmp    80105c1b <alltraps>
...
801069e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801069ee:	e9 28 f2 ff ff       	jmp    80105c1b <alltraps>
...
801069f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801069fa:	e9 1c f2 ff ff       	jmp    80105c1b <alltraps>
...
80106a01:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106a06:	e9 10 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106a0d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106a12:	e9 04 f2 ff ff       	jmp    80105c1b <alltraps>
...
80106a19:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106a1e:	e9 f8 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a25:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106a2a:	e9 ec f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a31:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106a36:	e9 e0 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a3d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106a42:	e9 d4 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a49:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106a4e:	e9 c8 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a55:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106a5a:	e9 bc f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a61:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106a66:	e9 b0 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a6d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106a72:	e9 a4 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a79:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106a7e:	e9 98 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a85:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106a8a:	e9 8c f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a91:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106a96:	e9 80 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106a9d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106aa2:	e9 74 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106aa9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106aae:	e9 68 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106ab5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106aba:	e9 5c f1 ff ff       	jmp    80105c1b <alltraps>
...
80106ac1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106ac6:	e9 50 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106acd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106ad2:	e9 44 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106ad9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106ade:	e9 38 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106ae5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106aea:	e9 2c f1 ff ff       	jmp    80105c1b <alltraps>
...
80106af1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106af6:	e9 20 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106afd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106b02:	e9 14 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106b09:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106b0e:	e9 08 f1 ff ff       	jmp    80105c1b <alltraps>
...
80106b15:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106b1a:	e9 fc f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b21:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106b26:	e9 f0 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b2d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106b32:	e9 e4 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b39:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106b3e:	e9 d8 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b45:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106b4a:	e9 cc f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b51:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106b56:	e9 c0 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b5d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106b62:	e9 b4 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b69:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106b6e:	e9 a8 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b75:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106b7a:	e9 9c f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b81:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106b86:	e9 90 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b8d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106b92:	e9 84 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106b99:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106b9e:	e9 78 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106ba5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106baa:	e9 6c f0 ff ff       	jmp    80105c1b <alltraps>
...
80106bb1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106bb6:	e9 60 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106bbd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106bc2:	e9 54 f0 ff ff       	jmp    80105c1b <alltraps>
...
80106c6f:	68 26 79 10 80       	push   $0x80107926
...
80106d15:	e8 f6 da ff ff       	call   80104810 <memset>
...
80106d5d:	68 e8 7f 10 80       	push   $0x80107fe8
...
80106d73:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106d76:	e8 05 cc ff ff       	call   80103980 <cpuid>
  pd[0] = size-1;
...
80106e00:	a1 c4 58 11 80       	mov    0x801158c4,%eax
...
80106e34:	0f 84 c2 00 00 00    	je     80106efc <switchuvm+0xec>
  pushcli();
80106e3a:	e8 c1 d7 ff ff       	call   80104600 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106e3f:	e8 dc ca ff ff       	call   80103920 <mycpu>
80106e44:	89 c3                	mov    %eax,%ebx
80106e46:	e8 d5 ca ff ff       	call   80103920 <mycpu>
80106e4b:	89 c7                	mov    %eax,%edi
80106e4d:	e8 ce ca ff ff       	call   80103920 <mycpu>
80106e52:	83 c7 08             	add    $0x8,%edi
80106e55:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106e58:	e8 c3 ca ff ff       	call   80103920 <mycpu>
...
80106f4f:	e8 bc d8 ff ff       	call   80104810 <memset>
...
80106f82:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106f83:	e9 28 d9 ff ff       	jmp    801048b0 <memmove>
    panic("inituvm: more than a page");
80106f88:	83 ec 0c             	sub    $0xc,%esp
80106f8b:	68 2d 80 10 80       	push   $0x8010802d
...
80106ff0:	68 47 80 10 80       	push   $0x80108047
...
80107078:	68 18 81 10 80       	push   $0x80108118
...
801070db:	e8 30 d7 ff ff       	call   80104810 <memset>
...
80107119:	68 65 80 10 80       	push   $0x80108065
...
8010717b:	68 7d 80 10 80       	push   $0x8010807d
...
8010725c:	68 99 80 10 80       	push   $0x80108099
...
80107290:	e8 7b d5 ff ff       	call   80104810 <memset>
...
801072fb:	a3 c4 58 11 80       	mov    %eax,0x801158c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010732c:	68 aa 80 10 80       	push   $0x801080aa
...
801073a2:	68 b4 80 10 80       	push   $0x801080b4
...
80107400:	e8 ab d4 ff ff       	call   801048b0 <memmove>
...
80107477:	68 ce 80 10 80       	push   $0x801080ce
...
801074a4:	0f 84 08 02 00 00    	je     801076b2 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
80107530:	e8 7b d3 ff ff       	call   801048b0 <memmove>
    len -= n;
    buf += n;
...
8010755d:	0f 84 56 01 00 00    	je     801076b9 <copyout.cold>
  return &pgtab[PTX(va)];
...
801075ba:	83 ec 0c             	sub    $0xc,%esp
  pde_t* pgdir = myproc()->pgdir;
801075bd:	e8 de c3 ff ff       	call   801039a0 <myproc>
801075c2:	8b 78 04             	mov    0x4(%eax),%edi
  while(va < myproc()->sz){
801075c5:	eb 41                	jmp    80107608 <num_phy_page+0x58>
801075c7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801075ce:	66 90                	xchg   %ax,%ax
  pde = &pgdir[PDX(va)];
801075d0:	89 d8                	mov    %ebx,%eax
801075d2:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
801075d5:	8b 04 87             	mov    (%edi,%eax,4),%eax
801075d8:	a8 01                	test   $0x1,%al
801075da:	74 26                	je     80107602 <num_phy_page+0x52>
  return &pgtab[PTX(va)];
801075dc:	89 da                	mov    %ebx,%edx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801075de:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
801075e3:	c1 ea 0a             	shr    $0xa,%edx
801075e6:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
801075ec:	8d 84 10 00 00 00 80 	lea    -0x80000000(%eax,%edx,1),%eax
    pte_t* pte = walkpgdir(pgdir, (void*)va, 0);
    if(pte && (*pte & PTE_P)) k++;
801075f3:	85 c0                	test   %eax,%eax
801075f5:	74 0b                	je     80107602 <num_phy_page+0x52>
801075f7:	8b 00                	mov    (%eax),%eax
801075f9:	83 e0 01             	and    $0x1,%eax
801075fc:	83 f8 01             	cmp    $0x1,%eax
801075ff:	83 de ff             	sbb    $0xffffffff,%esi
    va = va + PGSIZE;
80107602:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  while(va < myproc()->sz){
80107608:	e8 93 c3 ff ff       	call   801039a0 <myproc>
8010760d:	39 18                	cmp    %ebx,(%eax)
8010760f:	77 bf                	ja     801075d0 <num_phy_page+0x20>
  }

  return k;
}
80107611:	83 c4 0c             	add    $0xc,%esp
80107614:	89 f0                	mov    %esi,%eax
80107616:	5b                   	pop    %ebx
80107617:	5e                   	pop    %esi
80107618:	5f                   	pop    %edi
80107619:	5d                   	pop    %ebp
...
80107620 <allocate_on_pgflt>:

void
allocate_on_pgflt(uint va){
80107620:	55                   	push   %ebp
80107621:	89 e5                	mov    %esp,%ebp
80107623:	56                   	push   %esi
80107624:	53                   	push   %ebx
80107625:	8b 75 08             	mov    0x8(%ebp),%esi
  char* mem;
  mem = kalloc();
80107628:	e8 53 b0 ff ff       	call   80102680 <kalloc>
  if(mem == 0){
8010762d:	85 c0                	test   %eax,%eax
8010762f:	74 6f                	je     801076a0 <allocate_on_pgflt+0x80>
    // cprintf("allocuvm out of memory\n");
...
80107636:	68 00 10 00 00       	push   $0x1000
8010763b:	6a 00                	push   $0x0
8010763d:	50                   	push   %eax
8010763e:	e8 cd d1 ff ff       	call   80104810 <memset>
  if(mappages(myproc()->pgdir, (char*)va, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80107643:	e8 58 c3 ff ff       	call   801039a0 <myproc>
80107648:	5a                   	pop    %edx
80107649:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
8010764f:	59                   	pop    %ecx
80107650:	8b 40 04             	mov    0x4(%eax),%eax
80107653:	6a 06                	push   $0x6
80107655:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010765a:	52                   	push   %edx
8010765b:	89 f2                	mov    %esi,%edx
8010765d:	e8 1e f6 ff ff       	call   80106c80 <mappages>
80107662:	83 c4 10             	add    $0x10,%esp
80107665:	85 c0                	test   %eax,%eax
80107667:	78 17                	js     80107680 <allocate_on_pgflt+0x60>
  ...
  switchuvm(myproc());
80107669:	e8 32 c3 ff ff       	call   801039a0 <myproc>
8010766e:	89 45 08             	mov    %eax,0x8(%ebp)
}
80107671:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107674:	5b                   	pop    %ebx
80107675:	5e                   	pop    %esi
80107676:	5d                   	pop    %ebp
  switchuvm(myproc());
80107677:	e9 94 f7 ff ff       	jmp    80106e10 <switchuvm>
8010767c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      cprintf("Error: out of memory (2)\n");
80107680:	83 ec 0c             	sub    $0xc,%esp
80107683:	68 fe 80 10 80       	push   $0x801080fe
80107688:	e8 13 90 ff ff       	call   801006a0 <cprintf>
      kfree(mem);
8010768d:	89 5d 08             	mov    %ebx,0x8(%ebp)
80107690:	83 c4 10             	add    $0x10,%esp
}
80107693:	8d 65 f8             	lea    -0x8(%ebp),%esp
80107696:	5b                   	pop    %ebx
80107697:	5e                   	pop    %esi
80107698:	5d                   	pop    %ebp
      kfree(mem);
80107699:	e9 22 ae ff ff       	jmp    801024c0 <kfree>
8010769e:	66 90                	xchg   %ax,%ax
    cprintf("Error: out of memory\n");
801076a0:	c7 45 08 e8 80 10 80 	movl   $0x801080e8,0x8(%ebp)
}
801076a7:	8d 65 f8             	lea    -0x8(%ebp),%esp
801076aa:	5b                   	pop    %ebx
801076ab:	5e                   	pop    %esi
801076ac:	5d                   	pop    %ebp
    cprintf("Error: out of memory\n");
801076ad:	e9 ee 8f ff ff       	jmp    801006a0 <cprintf>

801076b2 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801076b2:	a1 00 00 00 00       	mov    0x0,%eax
801076b7:	0f 0b                	ud2    

801076b9 <copyout.cold>:
801076b9:	a1 00 00 00 00       	mov    0x0,%eax
801076be:	0f 0b                	ud2    
